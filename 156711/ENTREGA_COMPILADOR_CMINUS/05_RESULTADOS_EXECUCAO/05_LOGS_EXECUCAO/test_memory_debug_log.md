...
ADD_INSTRUCTION[28]: LI (op=27) rs=R0 rt=R13 rd=R0 imm=0
...
ADD_INSTRUCTION[33]: LI (op=27) rs=R0 rt=R16 rd=R0 imm=1
...
ADD_INSTRUCTION[37]: OUTPUTREG (op=32) rs=R18 rt=R0 rd=R0 imm=0
DEBUG: get_register_for_variable('t12', 'main')
DEBUG: Registrador livre encontrado: R19
DEBUG: Alocando 't12' -> R19
ADD_INSTRUCTION[38]: LI (op=27) rs=R0 rt=R19 rd=R0 imm=2
...
ADD_INSTRUCTION[39]: ADDI (op=15) rs=R28 rt=R20 rd=R0 imm=0
  ADDI PREVIEW: Will output 'ADDI R20, R28, 0'
Generating: ADD R20, R20, R19 (final address = base + index)
ADD_INSTRUCTION[40]: ADD (op=0) rs=R20 rt=R19 rd=R20 imm=0
...
ADD_INSTRUCTION[41]: LW (op=25) rs=R20 rt=R21 rd=R0 imm=0
...
ADD_INSTRUCTION[42]: OUTPUTREG (op=32) rs=R21 rt=R0 rd=R0 imm=0
DEBUG: get_register_for_variable('t14', 'main')
DEBUG: Registrador livre encontrado: R22
DEBUG: Alocando 't14' -> R22
ADD_INSTRUCTION[43]: LI (op=27) rs=R0 rt=R22 rd=R0 imm=3
...
Index register: R22 (loaded from 't14')
DEBUG: get_register_for_variable('addr_reg_7', 'main')
DEBUG: Registrador livre encontrado: R23
DEBUG: Alocando 'addr_reg_7' -> R23
Address register: R23 (addr_reg_7)
Global array: GP=28, offset=0
Generating: ADDI R23, GP, 0 (base address)
ADD_INSTRUCTION[44]: ADDI (op=15) rs=R28 rt=R23 rd=R0 imm=0
  ADDI PREVIEW: Will output 'ADDI R23, R28, 0'
Generating: ADD R23, R23, R22 (final address = base + index)
ADD_INSTRUCTION[45]: ADD (op=0) rs=R23 rt=R22 rd=R23 imm=0
...
LOAD: Dest register R24 (to 't15')
Generating: LW R24, 0(R23) (load value from address)
ADD_INSTRUCTION[46]: LW (op=25) rs=R23 rt=R24 rd=R0 imm=0
...
ADD_INSTRUCTION[47]: OUTPUTREG (op=32) rs=R24 rt=R0 rd=R0 imm=0
ADD_INSTRUCTION[48]: HALT (op=30) rs=R0 rt=R0 rd=R0 imm=0

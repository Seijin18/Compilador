...
def test_core_functionality():
    ...
    try:
        ...
        try:
            ...
            if (simulator.registers[1] == 100 and 
                simulator.registers[2] == 30 and 
                simulator.registers[3] == 130 and 
                simulator.registers[4] == 70 and 
                simulator.display_value == 130):
        ...
        try:
            ...
            if (simulator.registers[1] == 12 and 
                simulator.registers[2] == 7 and 
                simulator.registers[5] == 84 and 
                simulator.display_value == 84):
                print("   ✅ Multiplicação: PASSOU")
                test2_success = True
            else:
                print("   ❌ Multiplicação: FALHOU")
                print(f"      R1={simulator.registers[1]}, R2={simulator.registers[2]}")
                print(f"      R5={simulator.registers[5]}, Display={simulator.display_value}")
                test2_success = False
        except Exception as e:
        ...
        try:
            ...
            if (simulator.registers[1] == 15 and 
                simulator.registers[2] == 12 and 
                simulator.registers[3] == 12 and 
                simulator.registers[4] == 15 and 
                simulator.display_value == 15):
        ...
        try:
            ...
            if (simulator.registers[1] == 77 and 
                simulator.registers[3] == 77 and 
                simulator.memory[10] == 77 and 
                simulator.display_value == 77):
                ...
                print(f"      MEM[10]={simulator.memory[10]}, Display={simulator.display_value}")
                test4_success = False
        except Exception as e:
        ...
        try:
            ...
            if (simulator.registers[1] == 50 and 
                simulator.display_value == 50):
                print("   ✅ Entrada e saída: PASSOU")
                test5_success = True
            else:
                print("   ❌ Entrada e saída: FALHOU")
                print(f"      R1={simulator.registers[1]}, Display={simulator.display_value}")
                test5_success = False
        except Exception as e:
        ...
        print(f"\n🎯 RESULTADO FINAL:")
        print("=" * 40)
        print(f"Testes passaram: {tests_passed}/{total_tests} ({(tests_passed/total_tests)*100:.1f}%)")
        print("")
        ...
        print(f"4️⃣ Operações de memória: {'✅ PASSOU' if test4_success else '❌ FALHOU'}")

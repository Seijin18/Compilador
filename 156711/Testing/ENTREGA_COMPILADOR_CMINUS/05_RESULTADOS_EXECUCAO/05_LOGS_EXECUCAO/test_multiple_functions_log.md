...
ADD_INSTRUCTION[51]: MOVE (op=11) rs=R1 rt=R0 rd=R9 imm=0
DEBUG: add_instruction MOVE[51]: rs=1, rt=0, rd=9 (Armazenado: rs=1, rd=9)
...
ADD_INSTRUCTION[52]: MOVE (op=11) rs=R9 rt=R0 rd=R10 imm=0
DEBUG: add_instruction MOVE[52]: rs=9, rt=0, rd=10 (Armazenado: rs=9, rd=10)
...
ADD_INSTRUCTION[54]: LI (op=27) rs=R0 rt=R11 rd=R0 imm=2
...
DEBUG: Variável 'sumresult' -> R10 (símbolo encontrado: offset=2, global=0)ADD_INSTRUCTION[55]: LW (op=25) rs=R30 rt=R10 rd=R0 imm=2
  MEM PREVIEW: Will output 'LW R10, 2(R30)'

DEBUG: Parâmetro 0: 'sumresult' de R10 para R4 (forçado)
ADD_INSTRUCTION[56]: MOVE (op=11) rs=R10 rt=R0 rd=R4 imm=0
DEBUG: add_instruction MOVE[56]: rs=10, rt=0, rd=4 (Armazenado: rs=10, rd=4)
...
ADD_INSTRUCTION[57]: MOVE (op=11) rs=R11 rt=R0 rd=R5 imm=0
DEBUG: add_instruction MOVE[57]: rs=11, rt=0, rd=5 (Armazenado: rs=11, rd=5)
...
ADD_INSTRUCTION[59]: MOVE (op=11) rs=R1 rt=R0 rd=R12 imm=0
DEBUG: add_instruction MOVE[59]: rs=1, rt=0, rd=12 (Armazenado: rs=1, rd=12)
...
ADD_INSTRUCTION[60]: MOVE (op=11) rs=R12 rt=R0 rd=R13 imm=0
DEBUG: add_instruction MOVE[60]: rs=12, rt=0, rd=13 (Armazenado: rs=12, rd=13)
ADD_INSTRUCTION[61]: SW (op=26) rs=R30 rt=R13 rd=R0 imm=3
...
DEBUG: Variável 'multresult' -> R13 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[62]: LW (op=25) rs=R30 rt=R13 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R13, 3(R30)'

DEBUG: add_move_if_different(R13 -> R1)
DEBUG: Gerando MOVE R1, R13
ADD_INSTRUCTION[63]: MOVE (op=11) rs=R13 rt=R0 rd=R1 imm=0
DEBUG: add_instruction MOVE[63]: rs=13, rt=0, rd=1 (Armazenado: rs=13, rd=1)
DEBUG_RA: === INICIO EPILOGO FUNCAO ===
DEBUG_RA: Restaurando RA do stack usando SP original
...
ADD_INSTRUCTION[75]: LI (op=27) rs=R0 rt=R14 rd=R0 imm=3
DEBUG: get_register_for_variable('t6', 'main')
DEBUG: Registrador livre encontrado: R15
DEBUG: Alocando 't6' -> R15
ADD_INSTRUCTION[76]: LI (op=27) rs=R0 rt=R15 rd=R0 imm=7
...
ADD_INSTRUCTION[77]: MOVE (op=11) rs=R14 rt=R0 rd=R4 imm=0
DEBUG: add_instruction MOVE[77]: rs=14, rt=0, rd=4 (Armazenado: rs=14, rd=4)
...
ADD_INSTRUCTION[78]: MOVE (op=11) rs=R15 rt=R0 rd=R5 imm=0
DEBUG: add_instruction MOVE[78]: rs=15, rt=0, rd=5 (Armazenado: rs=15, rd=5)
...
ADD_INSTRUCTION[80]: MOVE (op=11) rs=R1 rt=R0 rd=R16 imm=0
DEBUG: add_instruction MOVE[80]: rs=1, rt=0, rd=16 (Armazenado: rs=1, rd=16)
ADD_INSTRUCTION[81]: MOVE (op=11) rs=R1 rt=R0 rd=R7 imm=0
DEBUG: add_instruction MOVE[81]: rs=1, rt=0, rd=7 (Armazenado: rs=1, rd=7)
...
ADD_INSTRUCTION[82]: MOVE (op=11) rs=R16 rt=R0 rd=R17 imm=0
DEBUG: add_instruction MOVE[82]: rs=16, rt=0, rd=17 (Armazenado: rs=16, rd=17)
ADD_INSTRUCTION[83]: SW (op=26) rs=R30 rt=R17 rd=R0 imm=0
...
DEBUG: Variável 'result' -> R17 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[84]: LW (op=25) rs=R30 rt=R17 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R17, 0(R30)'

ADD_INSTRUCTION[85]: OUTPUTREG (op=32) rs=R17 rt=R0 rd=R0 imm=0
ADD_INSTRUCTION[86]: HALT (op=30) rs=R0 rt=R0 rd=R0 imm=0

...
ADD_INSTRUCTION[13]: LI (op=27) rs=R0 rt=R1 rd=R0 imm=5
...
DEBUG: Variável 'param' -> R2 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[14]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=0
...
ADD_INSTRUCTION[15]: ADD (op=0) rs=R2 rt=R1 rd=R3 imm=0
...
ADD_INSTRUCTION[17]: SW (op=26) rs=R30 rt=R4 rd=R0 imm=1
...
ADD_INSTRUCTION[18]: LI (op=27) rs=R0 rt=R5 rd=R0 imm=2
DEBUG: load_variable_to_register('localvar', 'testscope')
DEBUG: get_register_for_variable('localvar', 'testscope')
DEBUG: Variável 'localvar' já em R4 (reutilizando)
DEBUG: Variável 'localvar' -> R4 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[19]: LW (op=25) rs=R30 rt=R4 rd=R0 imm=1
...
ADD_INSTRUCTION[20]: MULT (op=2) rs=R4 rt=R5 rd=R6 imm=0
...
ADD_INSTRUCTION[21]: MOVE (op=11) rs=R6 rt=R0 rd=R7 imm=0
DEBUG: add_instruction MOVE[21]: rs=6, rt=0, rd=7 (Armazenado: rs=6, rd=7)
ADD_INSTRUCTION[22]: SW (op=26) rs=R28 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R7, 0(R28)'
DEBUG: load_variable_to_register('localvar', 'testscope')
DEBUG: get_register_for_variable('localvar', 'testscope')
DEBUG: Variável 'localvar' já em R4 (reutilizando)
DEBUG: Variável 'localvar' -> R4 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[23]: LW (op=25) rs=R30 rt=R4 rd=R0 imm=1
  MEM PREVIEW: Will output 'LW R4, 1(R30)'

DEBUG: add_move_if_different(R4 -> R1)
DEBUG: Gerando MOVE R1, R4
ADD_INSTRUCTION[24]: MOVE (op=11) rs=R4 rt=R0 rd=R1 imm=0
DEBUG: add_instruction MOVE[24]: rs=4, rt=0, rd=1 (Armazenado: rs=4, rd=1)
DEBUG_RA: === INICIO EPILOGO FUNCAO ===
DEBUG_RA: Restaurando RA do stack usando SP original
ADD_INSTRUCTION[27]: LW (op=25) rs=R29 rt=R31 rd=R0 imm=7
  MEM PREVIEW: Will output 'LW R31, 7(R29)'
DEBUG_RA: Restaurando FP do stack usando SP original
ADD_INSTRUCTION[28]: LW (op=25) rs=R29 rt=R30 rd=R0 imm=6
  MEM PREVIEW: Will output 'LW R30, 6(R29)'
DEBUG_RA: Restaurando SP para posição anterior (SP+8)
ADD_INSTRUCTION[29]: ADDI (op=15) rs=R29 rt=R29 rd=R0 imm=8
  ADDI PREVIEW: Will output 'ADDI R29, R29, 8'
DEBUG_RA: Gerando JR RA para retorno
ADD_INSTRUCTION[30]: JR (op=12) rs=R31 rt=R0 rd=R0 imm=0
...
ADD_INSTRUCTION[33]: SW (op=26) rs=R2 rt=R30 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R30, 0(R2)'
ADD_INSTRUCTION[34]: SUBI (op=16) rs=R29 rt=R29 rd=R0 imm=2
ADD_INSTRUCTION[35]: MOVE (op=11) rs=R29 rt=R0 rd=R30 imm=0
DEBUG: add_instruction MOVE[35]: rs=29, rt=0, rd=30 (Armazenado: rs=29, rd=30)
...
ADD_INSTRUCTION[36]: LI (op=27) rs=R0 rt=R8 rd=R0 imm=100
...
ADD_INSTRUCTION[37]: MOVE (op=11) rs=R8 rt=R0 rd=R7 imm=0
DEBUG: add_instruction MOVE[37]: rs=8, rt=0, rd=7 (Armazenado: rs=8, rd=7)
ADD_INSTRUCTION[38]: SW (op=26) rs=R28 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R7, 0(R28)'
DEBUG: get_register_for_variable('t5', 'main')
DEBUG: Registrador livre encontrado: R9
DEBUG: Alocando 't5' -> R9
ADD_INSTRUCTION[39]: LI (op=27) rs=R0 rt=R9 rd=R0 imm=10
...
ADD_INSTRUCTION[40]: MOVE (op=11) rs=R9 rt=R0 rd=R4 imm=0
DEBUG: add_instruction MOVE[40]: rs=9, rt=0, rd=4 (Armazenado: rs=9, rd=4)
DEBUG: Salvando R2 (contém 'param') antes da chamada
ADD_INSTRUCTION[41]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[42]: SW (op=26) rs=R2 rt=R2 rd=R0 imm=0
...
ADD_INSTRUCTION[44]: SW (op=26) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R3, 0(R2)'
DEBUG: Salvando R5 (contém 't2') antes da chamada
ADD_INSTRUCTION[45]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=3
ADD_INSTRUCTION[46]: SW (op=26) rs=R2 rt=R5 rd=R0 imm=0
...
ADD_INSTRUCTION[48]: SW (op=26) rs=R2 rt=R6 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R6, 0(R2)'
DEBUG: Salvando R7 (contém 'globalvar') antes da chamada
ADD_INSTRUCTION[49]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=5
ADD_INSTRUCTION[50]: SW (op=26) rs=R2 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R7, 0(R2)'
DEBUG: Salvando R8 (contém 't4') antes da chamada
ADD_INSTRUCTION[51]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=6
ADD_INSTRUCTION[52]: SW (op=26) rs=R2 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R8, 0(R2)'
DEBUG: Salvando R9 (contém 't5') antes da chamada
ADD_INSTRUCTION[53]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=7
ADD_INSTRUCTION[54]: SW (op=26) rs=R2 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R9, 0(R2)'
ADD_INSTRUCTION[55]: SUBI (op=16) rs=R29 rt=R29 rd=R0 imm=7
ADD_INSTRUCTION[57]: ADDI (op=15) rs=R29 rt=R29 rd=R0 imm=7
  ADDI PREVIEW: Will output 'ADDI R29, R29, 7'
DEBUG: Restaurando R9 (contém 't5') após a chamada
ADD_INSTRUCTION[58]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=7
ADD_INSTRUCTION[59]: LW (op=25) rs=R2 rt=R9 rd=R0 imm=0
...
ADD_INSTRUCTION[61]: LW (op=25) rs=R2 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R8, 0(R2)'
DEBUG: Restaurando R7 (contém 'globalvar') após a chamada
ADD_INSTRUCTION[62]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=5
ADD_INSTRUCTION[63]: LW (op=25) rs=R2 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R7, 0(R2)'
DEBUG: Restaurando R6 (contém 't3') após a chamada
ADD_INSTRUCTION[64]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=4
ADD_INSTRUCTION[65]: LW (op=25) rs=R2 rt=R6 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R6, 0(R2)'
DEBUG: Restaurando R5 (contém 't2') após a chamada
ADD_INSTRUCTION[66]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=3
ADD_INSTRUCTION[67]: LW (op=25) rs=R2 rt=R5 rd=R0 imm=0
...
ADD_INSTRUCTION[69]: LW (op=25) rs=R2 rt=R3 rd=R0 imm=0
...
ADD_INSTRUCTION[71]: LW (op=25) rs=R2 rt=R2 rd=R0 imm=0
...
ADD_INSTRUCTION[72]: MOVE (op=11) rs=R1 rt=R0 rd=R10 imm=0
DEBUG: add_instruction MOVE[72]: rs=1, rt=0, rd=10 (Armazenado: rs=1, rd=10)
ADD_INSTRUCTION[73]: MOVE (op=11) rs=R1 rt=R0 rd=R7 imm=0
DEBUG: add_instruction MOVE[73]: rs=1, rt=0, rd=7 (Armazenado: rs=1, rd=7)
...
ADD_INSTRUCTION[74]: MOVE (op=11) rs=R10 rt=R0 rd=R11 imm=0
DEBUG: add_instruction MOVE[74]: rs=10, rt=0, rd=11 (Armazenado: rs=10, rd=11)
ADD_INSTRUCTION[75]: SW (op=26) rs=R30 rt=R11 rd=R0 imm=0
...
DEBUG: Variável 'localmain' -> R11 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[76]: LW (op=25) rs=R30 rt=R11 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R11, 0(R30)'

ADD_INSTRUCTION[77]: OUTPUTREG (op=32) rs=R11 rt=R0 rd=R0 imm=0
DEBUG: load_variable_to_register('globalvar', 'main')
DEBUG: get_register_for_variable('globalvar', 'main')
DEBUG: Variável 'globalvar' já em R7 (reutilizando)
DEBUG: Variável 'globalvar' -> R7 (símbolo encontrado: offset=0, global=1)ADD_INSTRUCTION[78]: LW (op=25) rs=R28 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R7, 0(R28)'

ADD_INSTRUCTION[79]: OUTPUTREG (op=32) rs=R7 rt=R0 rd=R0 imm=0
DEBUG: load_variable_to_register('globalvar', 'main')
DEBUG: get_register_for_variable('globalvar', 'main')
DEBUG: Variável 'globalvar' já em R7 (reutilizando)
DEBUG: Variável 'globalvar' -> R7 (símbolo encontrado: offset=0, global=1)ADD_INSTRUCTION[80]: LW (op=25) rs=R28 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R7, 0(R28)'

DEBUG: load_variable_to_register('localmain', 'main')
DEBUG: get_register_for_variable('localmain', 'main')
DEBUG: Variável 'localmain' já em R11 (reutilizando)
DEBUG: Variável 'localmain' -> R11 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[81]: LW (op=25) rs=R30 rt=R11 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R11, 0(R30)'

DEBUG: get_register_for_variable('t7', 'main')
DEBUG: Registrador livre encontrado: R12
DEBUG: Alocando 't7' -> R12
ADD_INSTRUCTION[82]: ADD (op=0) rs=R7 rt=R11 rd=R12 imm=0
...
ADD_INSTRUCTION[83]: MOVE (op=11) rs=R12 rt=R0 rd=R7 imm=0
DEBUG: add_instruction MOVE[83]: rs=12, rt=0, rd=7 (Armazenado: rs=12, rd=7)
ADD_INSTRUCTION[84]: SW (op=26) rs=R28 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R7, 0(R28)'
DEBUG: load_variable_to_register('globalvar', 'main')
DEBUG: get_register_for_variable('globalvar', 'main')
DEBUG: Variável 'globalvar' já em R7 (reutilizando)
DEBUG: Variável 'globalvar' -> R7 (símbolo encontrado: offset=0, global=1)ADD_INSTRUCTION[85]: LW (op=25) rs=R28 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R7, 0(R28)'

ADD_INSTRUCTION[86]: OUTPUTREG (op=32) rs=R7 rt=R0 rd=R0 imm=0
ADD_INSTRUCTION[87]: HALT (op=30) rs=R0 rt=R0 rd=R0 imm=0

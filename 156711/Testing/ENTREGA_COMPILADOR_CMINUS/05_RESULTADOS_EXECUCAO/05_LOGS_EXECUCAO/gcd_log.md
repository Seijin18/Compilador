...
ADD_INSTRUCTION[28]: MOVE (op=11) rs=R1 rt=R0 rd=R7 imm=0
DEBUG: add_instruction MOVE[28]: rs=1, rt=0, rd=7 (Armazenado: rs=1, rd=7)
...
ADD_INSTRUCTION[29]: MOVE (op=11) rs=R7 rt=R0 rd=R1 imm=0
DEBUG: add_instruction MOVE[29]: rs=7, rt=0, rd=1 (Armazenado: rs=7, rd=1)
...
ADD_INSTRUCTION[42]: INPUT (op=34) rs=R0 rt=R0 rd=R8 imm=0
ADD_INSTRUCTION[43]: OUTPUTREG (op=32) rs=R8 rt=R0 rd=R0 imm=0
...
ADD_INSTRUCTION[44]: MOVE (op=11) rs=R8 rt=R0 rd=R9 imm=0
DEBUG: add_instruction MOVE[44]: rs=8, rt=0, rd=9 (Armazenado: rs=8, rd=9)
ADD_INSTRUCTION[45]: SW (op=26) rs=R30 rt=R9 rd=R0 imm=0
...
ADD_INSTRUCTION[46]: INPUT (op=34) rs=R0 rt=R0 rd=R10 imm=0
ADD_INSTRUCTION[47]: OUTPUTREG (op=32) rs=R10 rt=R0 rd=R0 imm=0
...
ADD_INSTRUCTION[48]: MOVE (op=11) rs=R10 rt=R0 rd=R11 imm=0
DEBUG: add_instruction MOVE[48]: rs=10, rt=0, rd=11 (Armazenado: rs=10, rd=11)
ADD_INSTRUCTION[49]: SW (op=26) rs=R30 rt=R11 rd=R0 imm=1
...
DEBUG: Variável 'x' -> R9 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[50]: LW (op=25) rs=R30 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R9, 0(R30)'

DEBUG: Parâmetro 0: 'x' de R9 para R4 (forçado)
ADD_INSTRUCTION[51]: MOVE (op=11) rs=R9 rt=R0 rd=R4 imm=0
DEBUG: add_instruction MOVE[51]: rs=9, rt=0, rd=4 (Armazenado: rs=9, rd=4)
DEBUG: Passando parâmetro 1: 'y'
DEBUG: load_variable_to_register('y', 'main')
DEBUG: get_register_for_variable('y', 'main')
DEBUG: Variável 'y' já em R11 (reutilizando)
DEBUG: Variável 'y' -> R11 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[52]: LW (op=25) rs=R30 rt=R11 rd=R0 imm=1
...
ADD_INSTRUCTION[56]: MOVE (op=11) rs=R1 rt=R0 rd=R7 imm=0
DEBUG: add_instruction MOVE[56]: rs=1, rt=0, rd=7 (Armazenado: rs=1, rd=7)
...
ADD_INSTRUCTION[57]: OUTPUTREG (op=32) rs=R12 rt=R0 rd=R0 imm=0
ADD_INSTRUCTION[58]: HALT (op=30) rs=R0 rt=R0 rd=R0 imm=0

...
ADD_INSTRUCTION[15]: LI (op=27) rs=R0 rt=R1 rd=R0 imm=1
...
ADD_INSTRUCTION[18]: LI (op=27) rs=R0 rt=R3 rd=R0 imm=0
...
ADD_INSTRUCTION[19]: MOVE (op=11) rs=R3 rt=R0 rd=R1 imm=0
DEBUG: add_instruction MOVE[19]: rs=3, rt=0, rd=1 (Armazenado: rs=3, rd=1)
DEBUG: get_register_for_variable('t2', 'isPrime')
DEBUG: Registrador livre encontrado: R4
DEBUG: Alocando 't2' -> R4
ADD_INSTRUCTION[24]: LI (op=27) rs=R0 rt=R4 rd=R0 imm=2
...
ADD_INSTRUCTION[25]: MOVE (op=11) rs=R4 rt=R0 rd=R5 imm=0
DEBUG: add_instruction MOVE[25]: rs=4, rt=0, rd=5 (Armazenado: rs=4, rd=5)
...
DEBUG: Variável 'i' -> R5 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[27]: LW (op=25) rs=R30 rt=R5 rd=R0 imm=1
  MEM PREVIEW: Will output 'LW R5, 1(R30)'

DEBUG: load_variable_to_register('i', 'isPrime')
DEBUG: get_register_for_variable('i', 'isPrime')
DEBUG: Variável 'i' já em R5 (reutilizando)
DEBUG: Variável 'i' -> R5 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[28]: LW (op=25) rs=R30 rt=R5 rd=R0 imm=1
  MEM PREVIEW: Will output 'LW R5, 1(R30)'

DEBUG: get_register_for_variable('t3', 'isPrime')
DEBUG: Registrador livre encontrado: R6
DEBUG: Alocando 't3' -> R6
ADD_INSTRUCTION[29]: MULT (op=2) rs=R5 rt=R5 rd=R6 imm=0
...
ADD_INSTRUCTION[30]: MOVE (op=11) rs=R6 rt=R0 rd=R7 imm=0
DEBUG: add_instruction MOVE[30]: rs=6, rt=0, rd=7 (Armazenado: rs=6, rd=7)
ADD_INSTRUCTION[31]: SW (op=26) rs=R30 rt=R7 rd=R0 imm=3
  MEM PREVIEW: Will output 'SW R7, 3(R30)'
...
DEBUG: Variável 'k' -> R7 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[33]: LW (op=25) rs=R30 rt=R7 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R7, 3(R30)'

DEBUG: load_variable_to_register('n', 'isPrime')
DEBUG: get_register_for_variable('n', 'isPrime')
DEBUG: Variável 'n' já em R2 (reutilizando)
DEBUG: Variável 'n' -> R2 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[34]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R30)'
...
ADD_INSTRUCTION[35]: SLT (op=8) rs=R2 rt=R7 rd=R8 imm=0
DEBUG: SLT R8, R2, R7 (rt < rs, ou seja, rs > rt)
ADD_INSTRUCTION[36]: LI (op=27) rs=R0 rt=R1 rd=R0 imm=1
ADD_INSTRUCTION[37]: SUB (op=1) rs=R1 rt=R8 rd=R8 imm=0
...
ADD_INSTRUCTION[39]: LI (op=27) rs=R0 rt=R9 rd=R0 imm=0
...
ADD_INSTRUCTION[40]: MOVE (op=11) rs=R9 rt=R0 rd=R10 imm=0
DEBUG: add_instruction MOVE[40]: rs=9, rt=0, rd=10 (Armazenado: rs=9, rd=10)
ADD_INSTRUCTION[41]: SW (op=26) rs=R30 rt=R10 rd=R0 imm=2
...
DEBUG: Variável 'j' -> R10 (símbolo encontrado: offset=2, global=0)ADD_INSTRUCTION[43]: LW (op=25) rs=R30 rt=R10 rd=R0 imm=2
  MEM PREVIEW: Will output 'LW R10, 2(R30)'

DEBUG: load_variable_to_register('n', 'isPrime')
DEBUG: get_register_for_variable('n', 'isPrime')
DEBUG: Variável 'n' já em R2 (reutilizando)
DEBUG: Variável 'n' -> R2 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[44]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R30)'
...
ADD_INSTRUCTION[45]: SLT (op=8) rs=R2 rt=R10 rd=R11 imm=0
DEBUG: SLT R11, R2, R10 (rt < rs, ou seja, rs > rt)
ADD_INSTRUCTION[46]: LI (op=27) rs=R0 rt=R1 rd=R0 imm=1
ADD_INSTRUCTION[47]: SUB (op=1) rs=R1 rt=R11 rd=R11 imm=0
...
DEBUG: get_register_for_variable('j', 'isPrime')
DEBUG: Variável 'j' já em R10 (reutilizando)
DEBUG: Variável 'j' -> R10 (símbolo encontrado: offset=2, global=0)ADD_INSTRUCTION[49]: LW (op=25) rs=R30 rt=R10 rd=R0 imm=2
  MEM PREVIEW: Will output 'LW R10, 2(R30)'

DEBUG: load_variable_to_register('i', 'isPrime')
DEBUG: get_register_for_variable('i', 'isPrime')
DEBUG: Variável 'i' já em R5 (reutilizando)
DEBUG: Variável 'i' -> R5 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[50]: LW (op=25) rs=R30 rt=R5 rd=R0 imm=1
  MEM PREVIEW: Will output 'LW R5, 1(R30)'

DEBUG: get_register_for_variable('t7', 'isPrime')
DEBUG: Registrador livre encontrado: R12
DEBUG: Alocando 't7' -> R12
ADD_INSTRUCTION[51]: ADD (op=0) rs=R10 rt=R5 rd=R12 imm=0
...
ADD_INSTRUCTION[52]: MOVE (op=11) rs=R12 rt=R0 rd=R10 imm=0
DEBUG: add_instruction MOVE[52]: rs=12, rt=0, rd=10 (Armazenado: rs=12, rd=10)
ADD_INSTRUCTION[53]: SW (op=26) rs=R30 rt=R10 rd=R0 imm=2
  MEM PREVIEW: Will output 'SW R10, 2(R30)'
DEBUG: load_variable_to_register('n', 'isPrime')
DEBUG: get_register_for_variable('n', 'isPrime')
DEBUG: Variável 'n' já em R2 (reutilizando)
DEBUG: Variável 'n' -> R2 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[56]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R30)'

DEBUG: load_variable_to_register('i', 'isPrime')
DEBUG: get_register_for_variable('i', 'isPrime')
DEBUG: Variável 'i' já em R5 (reutilizando)
DEBUG: Variável 'i' -> R5 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[57]: LW (op=25) rs=R30 rt=R5 rd=R0 imm=1
  MEM PREVIEW: Will output 'LW R5, 1(R30)'

DEBUG: get_register_for_variable('t8', 'isPrime')
DEBUG: Registrador livre encontrado: R13
DEBUG: Alocando 't8' -> R13
ADD_INSTRUCTION[58]: ADD (op=0) rs=R2 rt=R5 rd=R13 imm=0
  ADD PREVIEW: Will output 'ADD R13, R2, R5'
DEBUG: load_variable_to_register('j', 'isPrime')
DEBUG: get_register_for_variable('j', 'isPrime')
DEBUG: Variável 'j' já em R10 (reutilizando)
DEBUG: Variável 'j' -> R10 (símbolo encontrado: offset=2, global=0)ADD_INSTRUCTION[59]: LW (op=25) rs=R30 rt=R10 rd=R0 imm=2
  MEM PREVIEW: Will output 'LW R10, 2(R30)'
...
ADD_INSTRUCTION[61]: LI (op=27) rs=R0 rt=R14 rd=R0 imm=0
...
ADD_INSTRUCTION[62]: MOVE (op=11) rs=R14 rt=R0 rd=R1 imm=0
DEBUG: add_instruction MOVE[62]: rs=14, rt=0, rd=1 (Armazenado: rs=14, rd=1)
...
DEBUG: get_register_for_variable('i', 'isPrime')
DEBUG: Variável 'i' já em R5 (reutilizando)
DEBUG: Variável 'i' -> R5 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[68]: LW (op=25) rs=R30 rt=R5 rd=R0 imm=1
  MEM PREVIEW: Will output 'LW R5, 1(R30)'
...
ADD_INSTRUCTION[69]: ADD (op=0) rs=R5 rt=R15 rd=R16 imm=0
...
ADD_INSTRUCTION[70]: MOVE (op=11) rs=R16 rt=R0 rd=R5 imm=0
DEBUG: add_instruction MOVE[70]: rs=16, rt=0, rd=5 (Armazenado: rs=16, rd=5)
ADD_INSTRUCTION[71]: SW (op=26) rs=R30 rt=R5 rd=R0 imm=1
  MEM PREVIEW: Will output 'SW R5, 1(R30)'
DEBUG: load_variable_to_register('i', 'isPrime')
DEBUG: get_register_for_variable('i', 'isPrime')
DEBUG: Variável 'i' já em R5 (reutilizando)
DEBUG: Variável 'i' -> R5 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[72]: LW (op=25) rs=R30 rt=R5 rd=R0 imm=1
  MEM PREVIEW: Will output 'LW R5, 1(R30)'

DEBUG: load_variable_to_register('i', 'isPrime')
DEBUG: get_register_for_variable('i', 'isPrime')
DEBUG: Variável 'i' já em R5 (reutilizando)
DEBUG: Variável 'i' -> R5 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[73]: LW (op=25) rs=R30 rt=R5 rd=R0 imm=1
  MEM PREVIEW: Will output 'LW R5, 1(R30)'

DEBUG: get_register_for_variable('t12', 'isPrime')
DEBUG: Registrador livre encontrado: R17
DEBUG: Alocando 't12' -> R17
ADD_INSTRUCTION[74]: MULT (op=2) rs=R5 rt=R5 rd=R17 imm=0
...
ADD_INSTRUCTION[75]: MOVE (op=11) rs=R17 rt=R0 rd=R7 imm=0
DEBUG: add_instruction MOVE[75]: rs=17, rt=0, rd=7 (Armazenado: rs=17, rd=7)
ADD_INSTRUCTION[76]: SW (op=26) rs=R30 rt=R7 rd=R0 imm=3
  MEM PREVIEW: Will output 'SW R7, 3(R30)'
DEBUG: get_register_for_variable('t13', 'isPrime')
DEBUG: Registrador livre encontrado: R18
DEBUG: Alocando 't13' -> R18
ADD_INSTRUCTION[79]: LI (op=27) rs=R0 rt=R18 rd=R0 imm=1
...
ADD_INSTRUCTION[80]: MOVE (op=11) rs=R18 rt=R0 rd=R1 imm=0
DEBUG: add_instruction MOVE[80]: rs=18, rt=0, rd=1 (Armazenado: rs=18, rd=1)
DEBUG_RA: === INICIO EPILOGO FUNCAO ===
DEBUG_RA: Restaurando RA do stack usando SP original
ADD_INSTRUCTION[83]: LW (op=25) rs=R29 rt=R31 rd=R0 imm=7
  MEM PREVIEW: Will output 'LW R31, 7(R29)'
DEBUG_RA: Restaurando FP do stack usando SP original
ADD_INSTRUCTION[84]: LW (op=25) rs=R29 rt=R30 rd=R0 imm=6
  MEM PREVIEW: Will output 'LW R30, 6(R29)'
DEBUG_RA: Restaurando SP para posição anterior (SP+8)
ADD_INSTRUCTION[85]: ADDI (op=15) rs=R29 rt=R29 rd=R0 imm=8
  ADDI PREVIEW: Will output 'ADDI R29, R29, 8'
DEBUG_RA: Gerando JR RA para retorno
ADD_INSTRUCTION[86]: JR (op=12) rs=R31 rt=R0 rd=R0 imm=0
DEBUG_RA: === FIM EPILOGO FUNCAO ===
DEBUG: Função 'main' detectada com 2 parâmetros totais
ADD_INSTRUCTION[88]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[89]: SW (op=26) rs=R2 rt=R30 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R30, 0(R2)'
ADD_INSTRUCTION[90]: SUBI (op=16) rs=R29 rt=R29 rd=R0 imm=2
ADD_INSTRUCTION[91]: MOVE (op=11) rs=R29 rt=R0 rd=R30 imm=0
DEBUG: add_instruction MOVE[91]: rs=29, rt=0, rd=30 (Armazenado: rs=29, rd=30)
...
ADD_INSTRUCTION[92]: INPUT (op=34) rs=R0 rt=R0 rd=R19 imm=0
ADD_INSTRUCTION[93]: OUTPUTREG (op=32) rs=R19 rt=R0 rd=R0 imm=0
...
ADD_INSTRUCTION[94]: MOVE (op=11) rs=R19 rt=R0 rd=R20 imm=0
DEBUG: add_instruction MOVE[94]: rs=19, rt=0, rd=20 (Armazenado: rs=19, rd=20)
ADD_INSTRUCTION[95]: SW (op=26) rs=R30 rt=R20 rd=R0 imm=0
...
DEBUG: Variável 'number' -> R20 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[96]: LW (op=25) rs=R30 rt=R20 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R20, 0(R30)'

DEBUG: Parâmetro 0: 'number' de R20 para R4 (forçado)
ADD_INSTRUCTION[97]: MOVE (op=11) rs=R20 rt=R0 rd=R4 imm=0
DEBUG: add_instruction MOVE[97]: rs=20, rt=0, rd=4 (Armazenado: rs=20, rd=4)
DEBUG: Salvando R2 (contém 'n') antes da chamada
ADD_INSTRUCTION[98]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[99]: SW (op=26) rs=R2 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R2, 0(R2)'
DEBUG: Salvando R3 (contém 't1') antes da chamada
ADD_INSTRUCTION[100]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[101]: SW (op=26) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R3, 0(R2)'
DEBUG: Salvando R5 (contém 'i') antes da chamada
ADD_INSTRUCTION[102]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=3
ADD_INSTRUCTION[103]: SW (op=26) rs=R2 rt=R5 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R5, 0(R2)'
DEBUG: Salvando R6 (contém 't3') antes da chamada
ADD_INSTRUCTION[104]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=4
ADD_INSTRUCTION[105]: SW (op=26) rs=R2 rt=R6 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R6, 0(R2)'
DEBUG: Salvando R7 (contém 'k') antes da chamada
ADD_INSTRUCTION[106]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=5
ADD_INSTRUCTION[107]: SW (op=26) rs=R2 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R7, 0(R2)'
DEBUG: Salvando R8 (contém 't4') antes da chamada
ADD_INSTRUCTION[108]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=6
ADD_INSTRUCTION[109]: SW (op=26) rs=R2 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R8, 0(R2)'
DEBUG: Salvando R9 (contém 't5') antes da chamada
ADD_INSTRUCTION[110]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=7
ADD_INSTRUCTION[111]: SW (op=26) rs=R2 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R9, 0(R2)'
DEBUG: Salvando R10 (contém 'j') antes da chamada
ADD_INSTRUCTION[112]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=8
ADD_INSTRUCTION[113]: SW (op=26) rs=R2 rt=R10 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R10, 0(R2)'
DEBUG: Salvando R11 (contém 't6') antes da chamada
ADD_INSTRUCTION[114]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=9
ADD_INSTRUCTION[115]: SW (op=26) rs=R2 rt=R11 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R11, 0(R2)'
DEBUG: Salvando R12 (contém 't7') antes da chamada
ADD_INSTRUCTION[116]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=10
ADD_INSTRUCTION[117]: SW (op=26) rs=R2 rt=R12 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R12, 0(R2)'
DEBUG: Salvando R13 (contém 't8') antes da chamada
ADD_INSTRUCTION[118]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=11
ADD_INSTRUCTION[119]: SW (op=26) rs=R2 rt=R13 rd=R0 imm=0
...
ADD_INSTRUCTION[121]: SW (op=26) rs=R2 rt=R14 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R14, 0(R2)'
DEBUG: Salvando R15 (contém 't10') antes da chamada
ADD_INSTRUCTION[122]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=13
ADD_INSTRUCTION[123]: SW (op=26) rs=R2 rt=R15 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R15, 0(R2)'
ADD_INSTRUCTION[124]: SUBI (op=16) rs=R29 rt=R29 rd=R0 imm=13
ADD_INSTRUCTION[126]: ADDI (op=15) rs=R29 rt=R29 rd=R0 imm=13
  ADDI PREVIEW: Will output 'ADDI R29, R29, 13'
DEBUG: Restaurando R15 (contém 't10') após a chamada
ADD_INSTRUCTION[127]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=13
ADD_INSTRUCTION[128]: LW (op=25) rs=R2 rt=R15 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R15, 0(R2)'
DEBUG: Restaurando R14 (contém 't9') após a chamada
ADD_INSTRUCTION[129]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=12
ADD_INSTRUCTION[130]: LW (op=25) rs=R2 rt=R14 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R14, 0(R2)'
DEBUG: Restaurando R13 (contém 't8') após a chamada
ADD_INSTRUCTION[131]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=11
ADD_INSTRUCTION[132]: LW (op=25) rs=R2 rt=R13 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R13, 0(R2)'
DEBUG: Restaurando R12 (contém 't7') após a chamada
ADD_INSTRUCTION[133]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=10
ADD_INSTRUCTION[134]: LW (op=25) rs=R2 rt=R12 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R12, 0(R2)'
DEBUG: Restaurando R11 (contém 't6') após a chamada
ADD_INSTRUCTION[135]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=9
ADD_INSTRUCTION[136]: LW (op=25) rs=R2 rt=R11 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R11, 0(R2)'
DEBUG: Restaurando R10 (contém 'j') após a chamada
ADD_INSTRUCTION[137]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=8
ADD_INSTRUCTION[138]: LW (op=25) rs=R2 rt=R10 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R10, 0(R2)'
DEBUG: Restaurando R9 (contém 't5') após a chamada
ADD_INSTRUCTION[139]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=7
ADD_INSTRUCTION[140]: LW (op=25) rs=R2 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R9, 0(R2)'
DEBUG: Restaurando R8 (contém 't4') após a chamada
ADD_INSTRUCTION[141]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=6
ADD_INSTRUCTION[142]: LW (op=25) rs=R2 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R8, 0(R2)'
DEBUG: Restaurando R7 (contém 'k') após a chamada
ADD_INSTRUCTION[143]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=5
ADD_INSTRUCTION[144]: LW (op=25) rs=R2 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R7, 0(R2)'
DEBUG: Restaurando R6 (contém 't3') após a chamada
ADD_INSTRUCTION[145]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=4
ADD_INSTRUCTION[146]: LW (op=25) rs=R2 rt=R6 rd=R0 imm=0
...
ADD_INSTRUCTION[148]: LW (op=25) rs=R2 rt=R5 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R5, 0(R2)'
DEBUG: Restaurando R3 (contém 't1') após a chamada
ADD_INSTRUCTION[149]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[150]: LW (op=25) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R3, 0(R2)'
DEBUG: Restaurando R2 (contém 'n') após a chamada
ADD_INSTRUCTION[151]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[152]: LW (op=25) rs=R2 rt=R2 rd=R0 imm=0
...
ADD_INSTRUCTION[153]: MOVE (op=11) rs=R1 rt=R0 rd=R21 imm=0
DEBUG: add_instruction MOVE[153]: rs=1, rt=0, rd=21 (Armazenado: rs=1, rd=21)
ADD_INSTRUCTION[154]: MOVE (op=11) rs=R1 rt=R0 rd=R7 imm=0
DEBUG: add_instruction MOVE[154]: rs=1, rt=0, rd=7 (Armazenado: rs=1, rd=7)
...
ADD_INSTRUCTION[155]: MOVE (op=11) rs=R21 rt=R0 rd=R22 imm=0
DEBUG: add_instruction MOVE[155]: rs=21, rt=0, rd=22 (Armazenado: rs=21, rd=22)
ADD_INSTRUCTION[156]: SW (op=26) rs=R30 rt=R22 rd=R0 imm=1
...
DEBUG: Variável 'result' -> R22 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[157]: LW (op=25) rs=R30 rt=R22 rd=R0 imm=1
  MEM PREVIEW: Will output 'LW R22, 1(R30)'

ADD_INSTRUCTION[158]: OUTPUTREG (op=32) rs=R22 rt=R0 rd=R0 imm=0
ADD_INSTRUCTION[159]: HALT (op=30) rs=R0 rt=R0 rd=R0 imm=0

...
DEBUG: Alocando 'x' -> R2
DEBUG: Variável 'x' -> R2 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[13]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=0
...
ADD_INSTRUCTION[15]: LI (op=27) rs=R0 rt=R3 rd=R0 imm=10
...
ADD_INSTRUCTION[17]: LI (op=27) rs=R0 rt=R4 rd=R0 imm=1
...
ADD_INSTRUCTION[18]: MOVE (op=11) rs=R4 rt=R0 rd=R1 imm=0
DEBUG: add_instruction MOVE[18]: rs=4, rt=0, rd=1 (Armazenado: rs=4, rd=1)
DEBUG: load_variable_to_register('x', 'fat')
DEBUG: get_register_for_variable('x', 'fat')
...
ADD_INSTRUCTION[23]: OUTPUTREG (op=32) rs=R2 rt=R0 rd=R0 imm=0
DEBUG: get_register_for_variable('t3', 'fat')
DEBUG: Registrador livre encontrado: R5
DEBUG: Alocando 't3' -> R5
ADD_INSTRUCTION[24]: LI (op=27) rs=R0 rt=R5 rd=R0 imm=1
DEBUG: load_variable_to_register('x', 'fat')
DEBUG: get_register_for_variable('x', 'fat')
DEBUG: Variável 'x' já em R2 (reutilizando)
DEBUG: Variável 'x' -> R2 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[25]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R30)'
...
ADD_INSTRUCTION[26]: SUB (op=1) rs=R2 rt=R5 rd=R6 imm=0
...
ADD_INSTRUCTION[27]: MOVE (op=11) rs=R6 rt=R0 rd=R4 imm=0
DEBUG: add_instruction MOVE[27]: rs=6, rt=0, rd=4 (Armazenado: rs=6, rd=4)
DEBUG: Salvando R2 (contém 'x') antes da chamada
ADD_INSTRUCTION[28]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[29]: SW (op=26) rs=R2 rt=R2 rd=R0 imm=0
...
ADD_INSTRUCTION[31]: SW (op=26) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R3, 0(R2)'
DEBUG: Salvando R5 (contém 't3') antes da chamada
ADD_INSTRUCTION[32]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=3
ADD_INSTRUCTION[33]: SW (op=26) rs=R2 rt=R5 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R5, 0(R2)'
DEBUG: Salvando R6 (contém 't4') antes da chamada
ADD_INSTRUCTION[34]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=4
ADD_INSTRUCTION[35]: SW (op=26) rs=R2 rt=R6 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R6, 0(R2)'
ADD_INSTRUCTION[36]: SUBI (op=16) rs=R29 rt=R29 rd=R0 imm=4
ADD_INSTRUCTION[38]: ADDI (op=15) rs=R29 rt=R29 rd=R0 imm=4
  ADDI PREVIEW: Will output 'ADDI R29, R29, 4'
DEBUG: Restaurando R6 (contém 't4') após a chamada
ADD_INSTRUCTION[39]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=4
ADD_INSTRUCTION[40]: LW (op=25) rs=R2 rt=R6 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R6, 0(R2)'
DEBUG: Restaurando R5 (contém 't3') após a chamada
ADD_INSTRUCTION[41]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=3
ADD_INSTRUCTION[42]: LW (op=25) rs=R2 rt=R5 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R5, 0(R2)'
DEBUG: Restaurando R3 (contém 't1') após a chamada
ADD_INSTRUCTION[43]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[44]: LW (op=25) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R3, 0(R2)'
DEBUG: Restaurando R2 (contém 'x') após a chamada
ADD_INSTRUCTION[45]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[46]: LW (op=25) rs=R2 rt=R2 rd=R0 imm=0
...
DEBUG: get_register_for_variable('x', 'fat')
DEBUG: Variável 'x' já em R2 (reutilizando)
DEBUG: Variável 'x' -> R2 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[48]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R30)'
...
ADD_INSTRUCTION[49]: MULT (op=2) rs=R2 rt=R7 rd=R8 imm=0
...
ADD_INSTRUCTION[50]: MOVE (op=11) rs=R8 rt=R0 rd=R1 imm=0
DEBUG: add_instruction MOVE[50]: rs=8, rt=0, rd=1 (Armazenado: rs=8, rd=1)
...
ADD_INSTRUCTION[63]: INPUT (op=34) rs=R0 rt=R0 rd=R9 imm=0
ADD_INSTRUCTION[64]: OUTPUTREG (op=32) rs=R9 rt=R0 rd=R0 imm=0
...
ADD_INSTRUCTION[65]: MOVE (op=11) rs=R9 rt=R0 rd=R2 imm=0
DEBUG: add_instruction MOVE[65]: rs=9, rt=0, rd=2 (Armazenado: rs=9, rd=2)
ADD_INSTRUCTION[66]: SW (op=26) rs=R30 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R2, 0(R30)'
DEBUG: Passando parâmetro 0: 'x'
DEBUG: load_variable_to_register('x', 'main')
DEBUG: get_register_for_variable('x', 'main')
DEBUG: Variável 'x' já em R2 (reutilizando)
DEBUG: Variável 'x' -> R2 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[67]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R30)'

DEBUG: Parâmetro 0: 'x' de R2 para R4 (forçado)
ADD_INSTRUCTION[68]: MOVE (op=11) rs=R2 rt=R0 rd=R4 imm=0
DEBUG: add_instruction MOVE[68]: rs=2, rt=0, rd=4 (Armazenado: rs=2, rd=4)
DEBUG: Salvando R2 (contém 'x') antes da chamada
ADD_INSTRUCTION[69]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[70]: SW (op=26) rs=R2 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R2, 0(R2)'
DEBUG: Salvando R3 (contém 't1') antes da chamada
ADD_INSTRUCTION[71]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[72]: SW (op=26) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R3, 0(R2)'
DEBUG: Salvando R5 (contém 't3') antes da chamada
ADD_INSTRUCTION[73]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=3
ADD_INSTRUCTION[74]: SW (op=26) rs=R2 rt=R5 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R5, 0(R2)'
DEBUG: Salvando R6 (contém 't4') antes da chamada
ADD_INSTRUCTION[75]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=4
ADD_INSTRUCTION[76]: SW (op=26) rs=R2 rt=R6 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R6, 0(R2)'
DEBUG: Salvando R7 (contém 't5') antes da chamada
ADD_INSTRUCTION[77]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=5
ADD_INSTRUCTION[78]: SW (op=26) rs=R2 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R7, 0(R2)'
DEBUG: Salvando R8 (contém 't6') antes da chamada
ADD_INSTRUCTION[79]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=6
ADD_INSTRUCTION[80]: SW (op=26) rs=R2 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R8, 0(R2)'
DEBUG: Salvando R9 (contém 't7') antes da chamada
ADD_INSTRUCTION[81]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=7
ADD_INSTRUCTION[82]: SW (op=26) rs=R2 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R9, 0(R2)'
ADD_INSTRUCTION[83]: SUBI (op=16) rs=R29 rt=R29 rd=R0 imm=7
ADD_INSTRUCTION[85]: ADDI (op=15) rs=R29 rt=R29 rd=R0 imm=7
  ADDI PREVIEW: Will output 'ADDI R29, R29, 7'
DEBUG: Restaurando R9 (contém 't7') após a chamada
ADD_INSTRUCTION[86]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=7
ADD_INSTRUCTION[87]: LW (op=25) rs=R2 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R9, 0(R2)'
DEBUG: Restaurando R8 (contém 't6') após a chamada
ADD_INSTRUCTION[88]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=6
ADD_INSTRUCTION[89]: LW (op=25) rs=R2 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R8, 0(R2)'
DEBUG: Restaurando R7 (contém 't5') após a chamada
ADD_INSTRUCTION[90]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=5
ADD_INSTRUCTION[91]: LW (op=25) rs=R2 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R7, 0(R2)'
DEBUG: Restaurando R6 (contém 't4') após a chamada
ADD_INSTRUCTION[92]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=4
ADD_INSTRUCTION[93]: LW (op=25) rs=R2 rt=R6 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R6, 0(R2)'
DEBUG: Restaurando R5 (contém 't3') após a chamada
ADD_INSTRUCTION[94]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=3
ADD_INSTRUCTION[95]: LW (op=25) rs=R2 rt=R5 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R5, 0(R2)'
DEBUG: Restaurando R3 (contém 't1') após a chamada
ADD_INSTRUCTION[96]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[97]: LW (op=25) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R3, 0(R2)'
DEBUG: Restaurando R2 (contém 'x') após a chamada
ADD_INSTRUCTION[98]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[99]: LW (op=25) rs=R2 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R2)'
...
ADD_INSTRUCTION[100]: MOVE (op=11) rs=R1 rt=R0 rd=R10 imm=0
DEBUG: add_instruction MOVE[100]: rs=1, rt=0, rd=10 (Armazenado: rs=1, rd=10)
ADD_INSTRUCTION[101]: MOVE (op=11) rs=R1 rt=R0 rd=R7 imm=0
DEBUG: add_instruction MOVE[101]: rs=1, rt=0, rd=7 (Armazenado: rs=1, rd=7)
...
ADD_INSTRUCTION[102]: OUTPUTREG (op=32) rs=R10 rt=R0 rd=R0 imm=0
ADD_INSTRUCTION[103]: HALT (op=30) rs=R0 rt=R0 rd=R0 imm=0

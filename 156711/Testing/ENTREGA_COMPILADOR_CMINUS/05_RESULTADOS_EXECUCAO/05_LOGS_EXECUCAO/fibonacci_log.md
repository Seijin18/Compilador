...
ADD_INSTRUCTION[16]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[17]: SW (op=26) rs=R2 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R2, 0(R2)'
DEBUG: Salvando R3 (contém 't1') antes da chamada
ADD_INSTRUCTION[18]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[19]: SW (op=26) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R3, 0(R2)'
ADD_INSTRUCTION[20]: SUBI (op=16) rs=R29 rt=R29 rd=R0 imm=2
ADD_INSTRUCTION[22]: ADDI (op=15) rs=R29 rt=R29 rd=R0 imm=2
  ADDI PREVIEW: Will output 'ADDI R29, R29, 2'
DEBUG: Restaurando R3 (contém 't1') após a chamada
ADD_INSTRUCTION[23]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[24]: LW (op=25) rs=R2 rt=R3 rd=R0 imm=0
...
ADD_INSTRUCTION[26]: LW (op=25) rs=R2 rt=R2 rd=R0 imm=0
...
ADD_INSTRUCTION[27]: MOVE (op=11) rs=R1 rt=R0 rd=R5 imm=0
DEBUG: add_instruction MOVE[27]: rs=1, rt=0, rd=5 (Armazenado: rs=1, rd=5)
DEBUG: get_register_for_variable('t4', 'fibonacci')
DEBUG: Registrador livre encontrado: R6
DEBUG: Alocando 't4' -> R6
ADD_INSTRUCTION[28]: LI (op=27) rs=R0 rt=R6 rd=R0 imm=2
DEBUG: load_variable_to_register('n', 'fibonacci')
DEBUG: get_register_for_variable('n', 'fibonacci')
DEBUG: Variável 'n' já em R2 (reutilizando)
DEBUG: Variável 'n' -> R2 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[29]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R30)'
...
ADD_INSTRUCTION[30]: SUB (op=1) rs=R2 rt=R6 rd=R7 imm=0
...
ADD_INSTRUCTION[31]: MOVE (op=11) rs=R7 rt=R0 rd=R4 imm=0
DEBUG: add_instruction MOVE[31]: rs=7, rt=0, rd=4 (Armazenado: rs=7, rd=4)
DEBUG: Salvando R2 (contém 'n') antes da chamada
ADD_INSTRUCTION[32]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[33]: SW (op=26) rs=R2 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R2, 0(R2)'
DEBUG: Salvando R3 (contém 't1') antes da chamada
ADD_INSTRUCTION[34]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[35]: SW (op=26) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R3, 0(R2)'
DEBUG: Salvando R5 (contém 't3') antes da chamada
ADD_INSTRUCTION[36]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=3
ADD_INSTRUCTION[37]: SW (op=26) rs=R2 rt=R5 rd=R0 imm=0
...
ADD_INSTRUCTION[39]: SW (op=26) rs=R2 rt=R6 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R6, 0(R2)'
DEBUG: Salvando R7 (contém 't5') antes da chamada
ADD_INSTRUCTION[40]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=5
ADD_INSTRUCTION[41]: SW (op=26) rs=R2 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R7, 0(R2)'
ADD_INSTRUCTION[42]: SUBI (op=16) rs=R29 rt=R29 rd=R0 imm=5
ADD_INSTRUCTION[44]: ADDI (op=15) rs=R29 rt=R29 rd=R0 imm=5
  ADDI PREVIEW: Will output 'ADDI R29, R29, 5'
DEBUG: Restaurando R7 (contém 't5') após a chamada
ADD_INSTRUCTION[45]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=5
ADD_INSTRUCTION[46]: LW (op=25) rs=R2 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R7, 0(R2)'
DEBUG: Restaurando R6 (contém 't4') após a chamada
ADD_INSTRUCTION[47]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=4
ADD_INSTRUCTION[48]: LW (op=25) rs=R2 rt=R6 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R6, 0(R2)'
DEBUG: Restaurando R5 (contém 't3') após a chamada
ADD_INSTRUCTION[49]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=3
ADD_INSTRUCTION[50]: LW (op=25) rs=R2 rt=R5 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R5, 0(R2)'
DEBUG: Restaurando R3 (contém 't1') após a chamada
ADD_INSTRUCTION[51]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[52]: LW (op=25) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R3, 0(R2)'
DEBUG: Restaurando R2 (contém 'n') após a chamada
ADD_INSTRUCTION[53]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[54]: LW (op=25) rs=R2 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R2)'
...
ADD_INSTRUCTION[55]: MOVE (op=11) rs=R1 rt=R0 rd=R8 imm=0
DEBUG: add_instruction MOVE[55]: rs=1, rt=0, rd=8 (Armazenado: rs=1, rd=8)
...
ADD_INSTRUCTION[56]: ADD (op=0) rs=R5 rt=R8 rd=R9 imm=0
...
ADD_INSTRUCTION[57]: MOVE (op=11) rs=R9 rt=R0 rd=R1 imm=0
DEBUG: add_instruction MOVE[57]: rs=9, rt=0, rd=1 (Armazenado: rs=9, rd=1)
DEBUG: load_variable_to_register('n', 'fibonacci')
DEBUG: get_register_for_variable('n', 'fibonacci')
DEBUG: Variável 'n' já em R2 (reutilizando)
DEBUG: Variável 'n' -> R2 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[61]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R30)'

DEBUG: add_move_if_different(R2 -> R1)
DEBUG: Gerando MOVE R1, R2
ADD_INSTRUCTION[62]: MOVE (op=11) rs=R2 rt=R0 rd=R1 imm=0
DEBUG: add_instruction MOVE[62]: rs=2, rt=0, rd=1 (Armazenado: rs=2, rd=1)
DEBUG_RA: === INICIO EPILOGO FUNCAO ===
DEBUG_RA: Restaurando RA do stack usando SP original
ADD_INSTRUCTION[66]: LW (op=25) rs=R29 rt=R31 rd=R0 imm=7
  MEM PREVIEW: Will output 'LW R31, 7(R29)'
DEBUG_RA: Restaurando FP do stack usando SP original
ADD_INSTRUCTION[67]: LW (op=25) rs=R29 rt=R30 rd=R0 imm=6
  MEM PREVIEW: Will output 'LW R30, 6(R29)'
DEBUG_RA: Restaurando SP para posição anterior (SP+8)
ADD_INSTRUCTION[68]: ADDI (op=15) rs=R29 rt=R29 rd=R0 imm=8
  ADDI PREVIEW: Will output 'ADDI R29, R29, 8'
DEBUG_RA: Gerando JR RA para retorno
ADD_INSTRUCTION[69]: JR (op=12) rs=R31 rt=R0 rd=R0 imm=0
DEBUG_RA: === FIM EPILOGO FUNCAO ===
DEBUG: Função 'main' detectada com 1 parâmetros totais
ADD_INSTRUCTION[71]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[72]: SW (op=26) rs=R2 rt=R30 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R30, 0(R2)'
ADD_INSTRUCTION[73]: SUBI (op=16) rs=R29 rt=R29 rd=R0 imm=2
ADD_INSTRUCTION[74]: MOVE (op=11) rs=R29 rt=R0 rd=R30 imm=0
DEBUG: add_instruction MOVE[74]: rs=29, rt=0, rd=30 (Armazenado: rs=29, rd=30)
...
ADD_INSTRUCTION[75]: INPUT (op=34) rs=R0 rt=R0 rd=R10 imm=0
ADD_INSTRUCTION[76]: OUTPUTREG (op=32) rs=R10 rt=R0 rd=R0 imm=0
...
ADD_INSTRUCTION[77]: MOVE (op=11) rs=R10 rt=R0 rd=R2 imm=0
DEBUG: add_instruction MOVE[77]: rs=10, rt=0, rd=2 (Armazenado: rs=10, rd=2)
ADD_INSTRUCTION[78]: SW (op=26) rs=R30 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R2, 0(R30)'
DEBUG: Passando parâmetro 0: 'n'
DEBUG: load_variable_to_register('n', 'main')
DEBUG: get_register_for_variable('n', 'main')
DEBUG: Variável 'n' já em R2 (reutilizando)
DEBUG: Variável 'n' -> R2 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[79]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R30)'

DEBUG: Parâmetro 0: 'n' de R2 para R4 (forçado)
ADD_INSTRUCTION[80]: MOVE (op=11) rs=R2 rt=R0 rd=R4 imm=0
DEBUG: add_instruction MOVE[80]: rs=2, rt=0, rd=4 (Armazenado: rs=2, rd=4)
DEBUG: Salvando R2 (contém 'n') antes da chamada
ADD_INSTRUCTION[81]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[82]: SW (op=26) rs=R2 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R2, 0(R2)'
DEBUG: Salvando R3 (contém 't1') antes da chamada
ADD_INSTRUCTION[83]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[84]: SW (op=26) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R3, 0(R2)'
DEBUG: Salvando R5 (contém 't3') antes da chamada
ADD_INSTRUCTION[85]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=3
ADD_INSTRUCTION[86]: SW (op=26) rs=R2 rt=R5 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R5, 0(R2)'
DEBUG: Salvando R6 (contém 't4') antes da chamada
ADD_INSTRUCTION[87]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=4
ADD_INSTRUCTION[88]: SW (op=26) rs=R2 rt=R6 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R6, 0(R2)'
DEBUG: Salvando R7 (contém 't5') antes da chamada
ADD_INSTRUCTION[89]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=5
ADD_INSTRUCTION[90]: SW (op=26) rs=R2 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R7, 0(R2)'
DEBUG: Salvando R8 (contém 't6') antes da chamada
ADD_INSTRUCTION[91]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=6
ADD_INSTRUCTION[92]: SW (op=26) rs=R2 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R8, 0(R2)'
DEBUG: Salvando R9 (contém 't7') antes da chamada
ADD_INSTRUCTION[93]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=7
ADD_INSTRUCTION[94]: SW (op=26) rs=R2 rt=R9 rd=R0 imm=0
...
ADD_INSTRUCTION[96]: SW (op=26) rs=R2 rt=R10 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R10, 0(R2)'
ADD_INSTRUCTION[97]: SUBI (op=16) rs=R29 rt=R29 rd=R0 imm=8
ADD_INSTRUCTION[99]: ADDI (op=15) rs=R29 rt=R29 rd=R0 imm=8
  ADDI PREVIEW: Will output 'ADDI R29, R29, 8'
DEBUG: Restaurando R10 (contém 't8') após a chamada
ADD_INSTRUCTION[100]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=8
ADD_INSTRUCTION[101]: LW (op=25) rs=R2 rt=R10 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R10, 0(R2)'
DEBUG: Restaurando R9 (contém 't7') após a chamada
ADD_INSTRUCTION[102]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=7
ADD_INSTRUCTION[103]: LW (op=25) rs=R2 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R9, 0(R2)'
DEBUG: Restaurando R8 (contém 't6') após a chamada
ADD_INSTRUCTION[104]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=6
ADD_INSTRUCTION[105]: LW (op=25) rs=R2 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R8, 0(R2)'
DEBUG: Restaurando R7 (contém 't5') após a chamada
ADD_INSTRUCTION[106]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=5
ADD_INSTRUCTION[107]: LW (op=25) rs=R2 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R7, 0(R2)'
DEBUG: Restaurando R6 (contém 't4') após a chamada
ADD_INSTRUCTION[108]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=4
ADD_INSTRUCTION[109]: LW (op=25) rs=R2 rt=R6 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R6, 0(R2)'
DEBUG: Restaurando R5 (contém 't3') após a chamada
ADD_INSTRUCTION[110]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=3
ADD_INSTRUCTION[111]: LW (op=25) rs=R2 rt=R5 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R5, 0(R2)'
DEBUG: Restaurando R3 (contém 't1') após a chamada
ADD_INSTRUCTION[112]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[113]: LW (op=25) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R3, 0(R2)'
DEBUG: Restaurando R2 (contém 'n') após a chamada
ADD_INSTRUCTION[114]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[115]: LW (op=25) rs=R2 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R2)'
...
ADD_INSTRUCTION[116]: MOVE (op=11) rs=R1 rt=R0 rd=R11 imm=0
DEBUG: add_instruction MOVE[116]: rs=1, rt=0, rd=11 (Armazenado: rs=1, rd=11)
ADD_INSTRUCTION[117]: MOVE (op=11) rs=R1 rt=R0 rd=R7 imm=0
DEBUG: add_instruction MOVE[117]: rs=1, rt=0, rd=7 (Armazenado: rs=1, rd=7)
...
ADD_INSTRUCTION[118]: OUTPUTREG (op=32) rs=R11 rt=R0 rd=R0 imm=0
ADD_INSTRUCTION[119]: HALT (op=30) rs=R0 rt=R0 rd=R0 imm=0

...
DEBUG: Variável 'a' -> R2 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[19]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R30)'

DEBUG: load_variable_to_register('b', 'main')
DEBUG: get_register_for_variable('b', 'main')
DEBUG: Variável 'b' já em R4 (reutilizando)
DEBUG: Variável 'b' -> R4 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[20]: LW (op=25) rs=R30 rt=R4 rd=R0 imm=1
...
ADD_INSTRUCTION[21]: ADD (op=0) rs=R2 rt=R4 rd=R5 imm=0
...
ADD_INSTRUCTION[22]: MOVE (op=11) rs=R5 rt=R0 rd=R6 imm=0
DEBUG: add_instruction MOVE[22]: rs=5, rt=0, rd=6 (Armazenado: rs=5, rd=6)
ADD_INSTRUCTION[23]: SW (op=26) rs=R30 rt=R6 rd=R0 imm=2
...
DEBUG: Variável 'resultado' -> R6 (símbolo encontrado: offset=2, global=0)ADD_INSTRUCTION[24]: LW (op=25) rs=R30 rt=R6 rd=R0 imm=2
  MEM PREVIEW: Will output 'LW R6, 2(R30)'

ADD_INSTRUCTION[25]: OUTPUTREG (op=32) rs=R6 rt=R0 rd=R0 imm=0
DEBUG: load_variable_to_register('a', 'main')
DEBUG: get_register_for_variable('a', 'main')
DEBUG: Variável 'a' já em R2 (reutilizando)
DEBUG: Variável 'a' -> R2 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[26]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R30)'
...
ADD_INSTRUCTION[28]: SUB (op=1) rs=R2 rt=R4 rd=R7 imm=0
...
ADD_INSTRUCTION[29]: MOVE (op=11) rs=R7 rt=R0 rd=R6 imm=0
DEBUG: add_instruction MOVE[29]: rs=7, rt=0, rd=6 (Armazenado: rs=7, rd=6)
ADD_INSTRUCTION[30]: SW (op=26) rs=R30 rt=R6 rd=R0 imm=2
  MEM PREVIEW: Will output 'SW R6, 2(R30)'
DEBUG: load_variable_to_register('resultado', 'main')
DEBUG: get_register_for_variable('resultado', 'main')
DEBUG: Variável 'resultado' já em R6 (reutilizando)
DEBUG: Variável 'resultado' -> R6 (símbolo encontrado: offset=2, global=0)ADD_INSTRUCTION[31]: LW (op=25) rs=R30 rt=R6 rd=R0 imm=2
  MEM PREVIEW: Will output 'LW R6, 2(R30)'

ADD_INSTRUCTION[32]: OUTPUTREG (op=32) rs=R6 rt=R0 rd=R0 imm=0
DEBUG: load_variable_to_register('a', 'main')
DEBUG: get_register_for_variable('a', 'main')
DEBUG: Variável 'a' já em R2 (reutilizando)
...
DEBUG: get_register_for_variable('b', 'main')
DEBUG: Variável 'b' já em R4 (reutilizando)
DEBUG: Variável 'b' -> R4 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[34]: LW (op=25) rs=R30 rt=R4 rd=R0 imm=1
  MEM PREVIEW: Will output 'LW R4, 1(R30)'

DEBUG: get_register_for_variable('t4', 'main')
DEBUG: Registrador livre encontrado: R8
DEBUG: Alocando 't4' -> R8
ADD_INSTRUCTION[35]: MULT (op=2) rs=R2 rt=R4 rd=R8 imm=0
...
ADD_INSTRUCTION[36]: MOVE (op=11) rs=R8 rt=R0 rd=R6 imm=0
DEBUG: add_instruction MOVE[36]: rs=8, rt=0, rd=6 (Armazenado: rs=8, rd=6)
ADD_INSTRUCTION[37]: SW (op=26) rs=R30 rt=R6 rd=R0 imm=2
  MEM PREVIEW: Will output 'SW R6, 2(R30)'
DEBUG: load_variable_to_register('resultado', 'main')
DEBUG: get_register_for_variable('resultado', 'main')
DEBUG: Variável 'resultado' já em R6 (reutilizando)
DEBUG: Variável 'resultado' -> R6 (símbolo encontrado: offset=2, global=0)ADD_INSTRUCTION[38]: LW (op=25) rs=R30 rt=R6 rd=R0 imm=2
  MEM PREVIEW: Will output 'LW R6, 2(R30)'

ADD_INSTRUCTION[39]: OUTPUTREG (op=32) rs=R6 rt=R0 rd=R0 imm=0
DEBUG: load_variable_to_register('a', 'main')
DEBUG: get_register_for_variable('a', 'main')
DEBUG: Variável 'a' já em R2 (reutilizando)
DEBUG: Variável 'a' -> R2 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[40]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R30)'

DEBUG: load_variable_to_register('b', 'main')
DEBUG: get_register_for_variable('b', 'main')
DEBUG: Variável 'b' já em R4 (reutilizando)
DEBUG: Variável 'b' -> R4 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[41]: LW (op=25) rs=R30 rt=R4 rd=R0 imm=1
  MEM PREVIEW: Will output 'LW R4, 1(R30)'

DEBUG: get_register_for_variable('t5', 'main')
DEBUG: Registrador livre encontrado: R9
DEBUG: Alocando 't5' -> R9
ADD_INSTRUCTION[42]: DIV (op=3) rs=R2 rt=R4 rd=R9 imm=0
...
ADD_INSTRUCTION[43]: MOVE (op=11) rs=R9 rt=R0 rd=R6 imm=0
DEBUG: add_instruction MOVE[43]: rs=9, rt=0, rd=6 (Armazenado: rs=9, rd=6)
ADD_INSTRUCTION[44]: SW (op=26) rs=R30 rt=R6 rd=R0 imm=2
  MEM PREVIEW: Will output 'SW R6, 2(R30)'
DEBUG: load_variable_to_register('resultado', 'main')
DEBUG: get_register_for_variable('resultado', 'main')
DEBUG: Variável 'resultado' já em R6 (reutilizando)
DEBUG: Variável 'resultado' -> R6 (símbolo encontrado: offset=2, global=0)ADD_INSTRUCTION[45]: LW (op=25) rs=R30 rt=R6 rd=R0 imm=2
  MEM PREVIEW: Will output 'LW R6, 2(R30)'

ADD_INSTRUCTION[46]: OUTPUTREG (op=32) rs=R6 rt=R0 rd=R0 imm=0
DEBUG: load_variable_to_register('a', 'main')
DEBUG: get_register_for_variable('a', 'main')
DEBUG: Variável 'a' já em R2 (reutilizando)
...
ADD_INSTRUCTION[50]: LI (op=27) rs=R0 rt=R10 rd=R0 imm=1
...
ADD_INSTRUCTION[51]: OUTPUTREG (op=32) rs=R10 rt=R0 rd=R0 imm=0
DEBUG: get_register_for_variable('t7', 'main')
DEBUG: Registrador livre encontrado: R11
DEBUG: Alocando 't7' -> R11
ADD_INSTRUCTION[54]: LI (op=27) rs=R0 rt=R11 rd=R0 imm=0
...
ADD_INSTRUCTION[55]: OUTPUTREG (op=32) rs=R11 rt=R0 rd=R0 imm=0
DEBUG: load_variable_to_register('a', 'main')
DEBUG: get_register_for_variable('a', 'main')
DEBUG: Variável 'a' já em R2 (reutilizando)
...
ADD_INSTRUCTION[60]: LI (op=27) rs=R0 rt=R12 rd=R0 imm=1
...
ADD_INSTRUCTION[61]: OUTPUTREG (op=32) rs=R12 rt=R0 rd=R0 imm=0
DEBUG: get_register_for_variable('t9', 'main')
DEBUG: Registrador livre encontrado: R13
DEBUG: Alocando 't9' -> R13
ADD_INSTRUCTION[64]: LI (op=27) rs=R0 rt=R13 rd=R0 imm=0
...
ADD_INSTRUCTION[65]: OUTPUTREG (op=32) rs=R13 rt=R0 rd=R0 imm=0
DEBUG: load_variable_to_register('a', 'main')
DEBUG: get_register_for_variable('a', 'main')
DEBUG: Variável 'a' já em R2 (reutilizando)
...
ADD_INSTRUCTION[70]: LI (op=27) rs=R0 rt=R14 rd=R0 imm=1
...
ADD_INSTRUCTION[71]: OUTPUTREG (op=32) rs=R14 rt=R0 rd=R0 imm=0
DEBUG: get_register_for_variable('t11', 'main')
DEBUG: Registrador livre encontrado: R15
DEBUG: Alocando 't11' -> R15
ADD_INSTRUCTION[74]: LI (op=27) rs=R0 rt=R15 rd=R0 imm=0
...
ADD_INSTRUCTION[75]: OUTPUTREG (op=32) rs=R15 rt=R0 rd=R0 imm=0
DEBUG: load_variable_to_register('a', 'main')
DEBUG: get_register_for_variable('a', 'main')
DEBUG: Variável 'a' já em R2 (reutilizando)
DEBUG: Variável 'a' -> R2 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[77]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R30)'

DEBUG: load_variable_to_register('b', 'main')
DEBUG: get_register_for_variable('b', 'main')
DEBUG: Variável 'b' já em R4 (reutilizando)
DEBUG: Variável 'b' -> R4 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[78]: LW (op=25) rs=R30 rt=R4 rd=R0 imm=1
  MEM PREVIEW: Will output 'LW R4, 1(R30)'

DEBUG: get_register_for_variable('t12', 'main')
DEBUG: Registrador livre encontrado: R16
DEBUG: Alocando 't12' -> R16
ADD_INSTRUCTION[80]: LI (op=27) rs=R0 rt=R16 rd=R0 imm=1
...
ADD_INSTRUCTION[81]: OUTPUTREG (op=32) rs=R16 rt=R0 rd=R0 imm=0
DEBUG: get_register_for_variable('t13', 'main')
DEBUG: Registrador livre encontrado: R17
DEBUG: Alocando 't13' -> R17
ADD_INSTRUCTION[84]: LI (op=27) rs=R0 rt=R17 rd=R0 imm=0
...
ADD_INSTRUCTION[85]: OUTPUTREG (op=32) rs=R17 rt=R0 rd=R0 imm=0

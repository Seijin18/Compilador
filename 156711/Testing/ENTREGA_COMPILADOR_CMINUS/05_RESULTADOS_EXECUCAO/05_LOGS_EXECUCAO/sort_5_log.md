...
ADD_INSTRUCTION[16]: LW (op=25) rs=R30 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R3, 0(R30)'
Generating: ADD R3, R3, R1 (final address = base + index)
ADD_INSTRUCTION[17]: ADD (op=0) rs=R3 rt=R1 rd=R3 imm=0
...
ADD_INSTRUCTION[18]: LW (op=25) rs=R3 rt=R4 rd=R0 imm=0
...
ADD_INSTRUCTION[19]: MOVE (op=11) rs=R4 rt=R0 rd=R5 imm=0
DEBUG: add_instruction MOVE[19]: rs=4, rt=0, rd=5 (Armazenado: rs=4, rd=5)
ADD_INSTRUCTION[20]: SW (op=26) rs=R30 rt=R5 rd=R0 imm=4
...
ADD_INSTRUCTION[21]: LI (op=27) rs=R0 rt=R6 rd=R0 imm=1
DEBUG: load_variable_to_register('low', 'minloc')
DEBUG: get_register_for_variable('low', 'minloc')
DEBUG: Variável 'low' já em R1 (reutilizando)
DEBUG: Variável 'low' -> R1 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[22]: LW (op=25) rs=R30 rt=R1 rd=R0 imm=1
  MEM PREVIEW: Will output 'LW R1, 1(R30)'
...
ADD_INSTRUCTION[23]: ADD (op=0) rs=R1 rt=R6 rd=R7 imm=0
...
ADD_INSTRUCTION[24]: MOVE (op=11) rs=R7 rt=R0 rd=R8 imm=0
DEBUG: add_instruction MOVE[24]: rs=7, rt=0, rd=8 (Armazenado: rs=7, rd=8)
ADD_INSTRUCTION[25]: SW (op=26) rs=R30 rt=R8 rd=R0 imm=3
  MEM PREVIEW: Will output 'SW R8, 3(R30)'
DEBUG: load_variable_to_register('i', 'minloc')
DEBUG: get_register_for_variable('i', 'minloc')
DEBUG: Variável 'i' já em R8 (reutilizando)
DEBUG: Variável 'i' -> R8 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[27]: LW (op=25) rs=R30 rt=R8 rd=R0 imm=3
...
DEBUG: Variável 'high' -> R9 (símbolo encontrado: offset=2, global=0)ADD_INSTRUCTION[28]: LW (op=25) rs=R30 rt=R9 rd=R0 imm=2
...
ADD_INSTRUCTION[29]: SLT (op=8) rs=R8 rt=R9 rd=R10 imm=0
...
DEBUG: get_register_for_variable('i', 'minloc')
DEBUG: Variável 'i' já em R8 (reutilizando)
DEBUG: Variável 'i' -> R8 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[31]: LW (op=25) rs=R30 rt=R8 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R8, 3(R30)'
...
ADD_INSTRUCTION[32]: LW (op=25) rs=R30 rt=R11 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R11, 0(R30)'
Generating: ADD R11, R11, R8 (final address = base + index)
ADD_INSTRUCTION[33]: ADD (op=0) rs=R11 rt=R8 rd=R11 imm=0
...
ADD_INSTRUCTION[34]: LW (op=25) rs=R11 rt=R12 rd=R0 imm=0
...
DEBUG: Variável 'x' -> R5 (símbolo encontrado: offset=4, global=0)ADD_INSTRUCTION[35]: LW (op=25) rs=R30 rt=R5 rd=R0 imm=4
...
DEBUG: get_register_for_variable('i', 'minloc')
DEBUG: Variável 'i' já em R8 (reutilizando)
DEBUG: Variável 'i' -> R8 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[37]: LW (op=25) rs=R30 rt=R8 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R8, 3(R30)'
...
ADD_INSTRUCTION[38]: LW (op=25) rs=R30 rt=R13 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R13, 0(R30)'
Generating: ADD R13, R13, R8 (final address = base + index)
ADD_INSTRUCTION[39]: ADD (op=0) rs=R13 rt=R8 rd=R13 imm=0
...
ADD_INSTRUCTION[40]: LW (op=25) rs=R13 rt=R14 rd=R0 imm=0
...
ADD_INSTRUCTION[41]: MOVE (op=11) rs=R14 rt=R0 rd=R5 imm=0
DEBUG: add_instruction MOVE[41]: rs=14, rt=0, rd=5 (Armazenado: rs=14, rd=5)
ADD_INSTRUCTION[42]: SW (op=26) rs=R30 rt=R5 rd=R0 imm=4
  MEM PREVIEW: Will output 'SW R5, 4(R30)'
DEBUG: load_variable_to_register('i', 'minloc')
DEBUG: get_register_for_variable('i', 'minloc')
DEBUG: Variável 'i' já em R8 (reutilizando)
DEBUG: Variável 'i' -> R8 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[43]: LW (op=25) rs=R30 rt=R8 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R8, 3(R30)'
...
ADD_INSTRUCTION[44]: MOVE (op=11) rs=R8 rt=R0 rd=R2 imm=0
DEBUG: add_instruction MOVE[44]: rs=8, rt=0, rd=2 (Armazenado: rs=8, rd=2)
ADD_INSTRUCTION[45]: SW (op=26) rs=R30 rt=R2 rd=R0 imm=5
  MEM PREVIEW: Will output 'SW R2, 5(R30)'
DEBUG: get_register_for_variable('t6', 'minloc')
DEBUG: Registrador livre encontrado: R15
DEBUG: Alocando 't6' -> R15
ADD_INSTRUCTION[49]: LI (op=27) rs=R0 rt=R15 rd=R0 imm=1
DEBUG: load_variable_to_register('i', 'minloc')
DEBUG: get_register_for_variable('i', 'minloc')
DEBUG: Variável 'i' já em R8 (reutilizando)
DEBUG: Variável 'i' -> R8 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[50]: LW (op=25) rs=R30 rt=R8 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R8, 3(R30)'
...
ADD_INSTRUCTION[51]: ADD (op=0) rs=R8 rt=R15 rd=R16 imm=0
...
ADD_INSTRUCTION[52]: MOVE (op=11) rs=R16 rt=R0 rd=R8 imm=0
DEBUG: add_instruction MOVE[52]: rs=16, rt=0, rd=8 (Armazenado: rs=16, rd=8)
ADD_INSTRUCTION[53]: SW (op=26) rs=R30 rt=R8 rd=R0 imm=3
  MEM PREVIEW: Will output 'SW R8, 3(R30)'
DEBUG: load_variable_to_register('k', 'minloc')
DEBUG: get_register_for_variable('k', 'minloc')
DEBUG: Variável 'k' já em R2 (reutilizando)
DEBUG: Variável 'k' -> R2 (símbolo encontrado: offset=5, global=0)ADD_INSTRUCTION[56]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=5
  MEM PREVIEW: Will output 'LW R2, 5(R30)'

DEBUG: add_move_if_different(R2 -> R1)
DEBUG: Gerando MOVE R1, R2
ADD_INSTRUCTION[57]: MOVE (op=11) rs=R2 rt=R0 rd=R1 imm=0
DEBUG: add_instruction MOVE[57]: rs=2, rt=0, rd=1 (Armazenado: rs=2, rd=1)
...
DEBUG_RA: === INICIO PROLOGO FUNCAO ===
DEBUG_RA: Decrementando SP em 8 posicoes
ADD_INSTRUCTION[65]: SUBI (op=16) rs=R29 rt=R29 rd=R0 imm=8
DEBUG_RA: Salvando RA no stack em posição relativa (SP+7)
ADD_INSTRUCTION[66]: SW (op=26) rs=R29 rt=R31 rd=R0 imm=7
  MEM PREVIEW: Will output 'SW R31, 7(R29)'
DEBUG_RA: Salvando FP no stack em posição relativa (SP+6)
ADD_INSTRUCTION[67]: SW (op=26) rs=R29 rt=R30 rd=R0 imm=6
  MEM PREVIEW: Will output 'SW R30, 6(R29)'
DEBUG_RA: Estabelecendo novo FP (SP+0)
...
DEBUG: Salvando 6 parâmetros de forma genérica
DEBUG: Salvando R4->offset 0
ADD_INSTRUCTION[69]: SW (op=26) rs=R30 rt=R4 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R4, 0(R30)'
DEBUG: Salvando R5->offset 1
ADD_INSTRUCTION[70]: SW (op=26) rs=R30 rt=R5 rd=R0 imm=1
  MEM PREVIEW: Will output 'SW R5, 1(R30)'
DEBUG: Salvando R6->offset 2
ADD_INSTRUCTION[71]: SW (op=26) rs=R30 rt=R6 rd=R0 imm=2
  MEM PREVIEW: Will output 'SW R6, 2(R30)'
DEBUG: Salvando R7->offset 3
ADD_INSTRUCTION[72]: SW (op=26) rs=R30 rt=R7 rd=R0 imm=3
  MEM PREVIEW: Will output 'SW R7, 3(R30)'
DEBUG: Local offset configurado para 6 (baseado em 6 parâmetros)
...
DEBUG: Variável 'low' já em R1 (reutilizando)
DEBUG: Variável 'low' -> R1 (símbolo encontrado: offset=1, global=0)ADD_INSTRUCTION[73]: LW (op=25) rs=R30 rt=R1 rd=R0 imm=1
  MEM PREVIEW: Will output 'LW R1, 1(R30)'
...
ADD_INSTRUCTION[74]: MOVE (op=11) rs=R1 rt=R0 rd=R8 imm=0
DEBUG: add_instruction MOVE[74]: rs=1, rt=0, rd=8 (Armazenado: rs=1, rd=8)
ADD_INSTRUCTION[75]: SW (op=26) rs=R30 rt=R8 rd=R0 imm=3
  MEM PREVIEW: Will output 'SW R8, 3(R30)'
DEBUG: get_register_for_variable('t8', 'sort')
DEBUG: Registrador livre encontrado: R17
DEBUG: Alocando 't8' -> R17
ADD_INSTRUCTION[77]: LI (op=27) rs=R0 rt=R17 rd=R0 imm=1
...
DEBUG: Variável 'high' -> R9 (símbolo encontrado: offset=2, global=0)ADD_INSTRUCTION[78]: LW (op=25) rs=R30 rt=R9 rd=R0 imm=2
  MEM PREVIEW: Will output 'LW R9, 2(R30)'
...
ADD_INSTRUCTION[79]: SUB (op=1) rs=R9 rt=R17 rd=R18 imm=0
DEBUG: load_variable_to_register('i', 'sort')
DEBUG: get_register_for_variable('i', 'sort')
DEBUG: Variável 'i' já em R8 (reutilizando)
DEBUG: Variável 'i' -> R8 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[80]: LW (op=25) rs=R30 rt=R8 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R8, 3(R30)'
...
ADD_INSTRUCTION[81]: SLT (op=8) rs=R8 rt=R18 rd=R19 imm=0
...
ADD_INSTRUCTION[83]: LW (op=25) rs=R30 rt=R20 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R20, 0(R30)'

DEBUG: Parâmetro 0: 'a' de R20 para R4 (forçado)
ADD_INSTRUCTION[84]: MOVE (op=11) rs=R20 rt=R0 rd=R4 imm=0
DEBUG: add_instruction MOVE[84]: rs=20, rt=0, rd=4 (Armazenado: rs=20, rd=4)
DEBUG: Passando parâmetro 1: 'i'
DEBUG: load_variable_to_register('i', 'sort')
DEBUG: get_register_for_variable('i', 'sort')
DEBUG: Variável 'i' já em R8 (reutilizando)
DEBUG: Variável 'i' -> R8 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[85]: LW (op=25) rs=R30 rt=R8 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R8, 3(R30)'

DEBUG: Parâmetro 1: 'i' de R8 para R5 (forçado)
ADD_INSTRUCTION[86]: MOVE (op=11) rs=R8 rt=R0 rd=R5 imm=0
DEBUG: add_instruction MOVE[86]: rs=8, rt=0, rd=5 (Armazenado: rs=8, rd=5)
DEBUG: Passando parâmetro 2: 'high'
DEBUG: load_variable_to_register('high', 'sort')
DEBUG: get_register_for_variable('high', 'sort')
DEBUG: Variável 'high' já em R9 (reutilizando)
DEBUG: Variável 'high' -> R9 (símbolo encontrado: offset=2, global=0)ADD_INSTRUCTION[87]: LW (op=25) rs=R30 rt=R9 rd=R0 imm=2
  MEM PREVIEW: Will output 'LW R9, 2(R30)'

DEBUG: Parâmetro 2: 'high' de R9 para R6 (forçado)
ADD_INSTRUCTION[88]: MOVE (op=11) rs=R9 rt=R0 rd=R6 imm=0
DEBUG: add_instruction MOVE[88]: rs=9, rt=0, rd=6 (Armazenado: rs=9, rd=6)
DEBUG: Salvando R2 (contém 'k') antes da chamada
ADD_INSTRUCTION[89]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[90]: SW (op=26) rs=R2 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R2, 0(R2)'
DEBUG: Salvando R3 (contém 'addr_reg_0') antes da chamada
ADD_INSTRUCTION[91]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[92]: SW (op=26) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R3, 0(R2)'
DEBUG: Salvando R5 (contém 'x') antes da chamada
ADD_INSTRUCTION[93]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=3
ADD_INSTRUCTION[94]: SW (op=26) rs=R2 rt=R5 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R5, 0(R2)'
DEBUG: Salvando R6 (contém 't1') antes da chamada
ADD_INSTRUCTION[95]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=4
ADD_INSTRUCTION[96]: SW (op=26) rs=R2 rt=R6 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R6, 0(R2)'
DEBUG: Salvando R7 (contém 't2') antes da chamada
ADD_INSTRUCTION[97]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=5
ADD_INSTRUCTION[98]: SW (op=26) rs=R2 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R7, 0(R2)'
DEBUG: Salvando R8 (contém 'i') antes da chamada
ADD_INSTRUCTION[99]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=6
ADD_INSTRUCTION[100]: SW (op=26) rs=R2 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R8, 0(R2)'
DEBUG: Salvando R9 (contém 'high') antes da chamada
ADD_INSTRUCTION[101]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=7
ADD_INSTRUCTION[102]: SW (op=26) rs=R2 rt=R9 rd=R0 imm=0
...
ADD_INSTRUCTION[104]: SW (op=26) rs=R2 rt=R10 rd=R0 imm=0
...
ADD_INSTRUCTION[106]: SW (op=26) rs=R2 rt=R11 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R11, 0(R2)'
DEBUG: Salvando R12 (contém 't4') antes da chamada
ADD_INSTRUCTION[107]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=10
ADD_INSTRUCTION[108]: SW (op=26) rs=R2 rt=R12 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R12, 0(R2)'
DEBUG: Salvando R13 (contém 'addr_reg_2') antes da chamada
ADD_INSTRUCTION[109]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=11
ADD_INSTRUCTION[110]: SW (op=26) rs=R2 rt=R13 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R13, 0(R2)'
DEBUG: Salvando R14 (contém 't5') antes da chamada
ADD_INSTRUCTION[111]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=12
ADD_INSTRUCTION[112]: SW (op=26) rs=R2 rt=R14 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R14, 0(R2)'
DEBUG: Salvando R15 (contém 't6') antes da chamada
ADD_INSTRUCTION[113]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=13
ADD_INSTRUCTION[114]: SW (op=26) rs=R2 rt=R15 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R15, 0(R2)'
ADD_INSTRUCTION[115]: SUBI (op=16) rs=R29 rt=R29 rd=R0 imm=13
ADD_INSTRUCTION[117]: ADDI (op=15) rs=R29 rt=R29 rd=R0 imm=13
  ADDI PREVIEW: Will output 'ADDI R29, R29, 13'
DEBUG: Restaurando R15 (contém 't6') após a chamada
ADD_INSTRUCTION[118]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=13
ADD_INSTRUCTION[119]: LW (op=25) rs=R2 rt=R15 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R15, 0(R2)'
DEBUG: Restaurando R14 (contém 't5') após a chamada
ADD_INSTRUCTION[120]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=12
ADD_INSTRUCTION[121]: LW (op=25) rs=R2 rt=R14 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R14, 0(R2)'
DEBUG: Restaurando R13 (contém 'addr_reg_2') após a chamada
ADD_INSTRUCTION[122]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=11
ADD_INSTRUCTION[123]: LW (op=25) rs=R2 rt=R13 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R13, 0(R2)'
DEBUG: Restaurando R12 (contém 't4') após a chamada
ADD_INSTRUCTION[124]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=10
ADD_INSTRUCTION[125]: LW (op=25) rs=R2 rt=R12 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R12, 0(R2)'
DEBUG: Restaurando R11 (contém 'addr_reg_1') após a chamada
ADD_INSTRUCTION[126]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=9
ADD_INSTRUCTION[127]: LW (op=25) rs=R2 rt=R11 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R11, 0(R2)'
DEBUG: Restaurando R10 (contém 't3') após a chamada
ADD_INSTRUCTION[128]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=8
ADD_INSTRUCTION[129]: LW (op=25) rs=R2 rt=R10 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R10, 0(R2)'
DEBUG: Restaurando R9 (contém 'high') após a chamada
ADD_INSTRUCTION[130]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=7
ADD_INSTRUCTION[131]: LW (op=25) rs=R2 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R9, 0(R2)'
DEBUG: Restaurando R8 (contém 'i') após a chamada
ADD_INSTRUCTION[132]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=6
ADD_INSTRUCTION[133]: LW (op=25) rs=R2 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R8, 0(R2)'
DEBUG: Restaurando R7 (contém 't2') após a chamada
ADD_INSTRUCTION[134]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=5
ADD_INSTRUCTION[135]: LW (op=25) rs=R2 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R7, 0(R2)'
DEBUG: Restaurando R6 (contém 't1') após a chamada
ADD_INSTRUCTION[136]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=4
ADD_INSTRUCTION[137]: LW (op=25) rs=R2 rt=R6 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R6, 0(R2)'
DEBUG: Restaurando R5 (contém 'x') após a chamada
ADD_INSTRUCTION[138]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=3
ADD_INSTRUCTION[139]: LW (op=25) rs=R2 rt=R5 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R5, 0(R2)'
DEBUG: Restaurando R3 (contém 'addr_reg_0') após a chamada
ADD_INSTRUCTION[140]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[141]: LW (op=25) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R3, 0(R2)'
DEBUG: Restaurando R2 (contém 'k') após a chamada
ADD_INSTRUCTION[142]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[143]: LW (op=25) rs=R2 rt=R2 rd=R0 imm=0
...
ADD_INSTRUCTION[144]: MOVE (op=11) rs=R1 rt=R0 rd=R21 imm=0
DEBUG: add_instruction MOVE[144]: rs=1, rt=0, rd=21 (Armazenado: rs=1, rd=21)
...
ADD_INSTRUCTION[145]: MOVE (op=11) rs=R21 rt=R0 rd=R2 imm=0
DEBUG: add_instruction MOVE[145]: rs=21, rt=0, rd=2 (Armazenado: rs=21, rd=2)
ADD_INSTRUCTION[146]: SW (op=26) rs=R30 rt=R2 rd=R0 imm=4
...
DEBUG: get_register_for_variable('k', 'sort')
DEBUG: Variável 'k' já em R2 (reutilizando)
DEBUG: Variável 'k' -> R2 (símbolo encontrado: offset=4, global=0)ADD_INSTRUCTION[147]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=4
...
ADD_INSTRUCTION[148]: LW (op=25) rs=R30 rt=R22 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R22, 0(R30)'
Generating: ADD R22, R22, R2 (final address = base + index)
ADD_INSTRUCTION[149]: ADD (op=0) rs=R22 rt=R2 rd=R22 imm=0
...
ADD_INSTRUCTION[150]: LW (op=25) rs=R22 rt=R23 rd=R0 imm=0
...
ADD_INSTRUCTION[151]: MOVE (op=11) rs=R23 rt=R0 rd=R24 imm=0
DEBUG: add_instruction MOVE[151]: rs=23, rt=0, rd=24 (Armazenado: rs=23, rd=24)
ADD_INSTRUCTION[152]: SW (op=26) rs=R30 rt=R24 rd=R0 imm=6
...
DEBUG: get_register_for_variable('i', 'sort')
DEBUG: Variável 'i' já em R8 (reutilizando)
DEBUG: Variável 'i' -> R8 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[153]: LW (op=25) rs=R30 rt=R8 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R8, 3(R30)'
...
ADD_INSTRUCTION[154]: LW (op=25) rs=R30 rt=R25 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R25, 0(R30)'
Generating: ADD R25, R25, R8 (final address = base + index)
ADD_INSTRUCTION[155]: ADD (op=0) rs=R25 rt=R8 rd=R25 imm=0
...
ADD_INSTRUCTION[156]: LW (op=25) rs=R25 rt=R26 rd=R0 imm=0
...
DEBUG: get_register_for_variable('k', 'sort')
DEBUG: Variável 'k' já em R2 (reutilizando)
DEBUG: Variável 'k' -> R2 (símbolo encontrado: offset=4, global=0)ADD_INSTRUCTION[157]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=4
  MEM PREVIEW: Will output 'LW R2, 4(R30)'
...
ADD_INSTRUCTION[158]: LW (op=25) rs=R30 rt=R27 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R27, 0(R30)'
Generating: ADD R27, R27, R2 (final address = base + index)
ADD_INSTRUCTION[159]: ADD (op=0) rs=R27 rt=R2 rd=R27 imm=0
...
ADD_INSTRUCTION[160]: SW (op=26) rs=R27 rt=R26 rd=R0 imm=0
...
DEBUG: get_register_for_variable('i', 'sort')
DEBUG: Variável 'i' já em R8 (reutilizando)
DEBUG: Variável 'i' -> R8 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[161]: LW (op=25) rs=R30 rt=R8 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R8, 3(R30)'
...
ADD_INSTRUCTION[166]: LI (op=27) rs=R0 rt=R4 rd=R0 imm=1
DEBUG: load_variable_to_register('i', 'sort')
DEBUG: get_register_for_variable('i', 'sort')
DEBUG: Variável 'i' já em R8 (reutilizando)
DEBUG: Variável 'i' -> R8 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[167]: LW (op=25) rs=R30 rt=R8 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R8, 3(R30)'
...
ADD_INSTRUCTION[168]: ADD (op=0) rs=R8 rt=R4 rd=R6 imm=0
...
ADD_INSTRUCTION[169]: MOVE (op=11) rs=R6 rt=R0 rd=R8 imm=0
DEBUG: add_instruction MOVE[169]: rs=6, rt=0, rd=8 (Armazenado: rs=6, rd=8)
ADD_INSTRUCTION[170]: SW (op=26) rs=R30 rt=R8 rd=R0 imm=3
  MEM PREVIEW: Will output 'SW R8, 3(R30)'
DEBUG_RA: === INICIO EPILOGO FUNCAO ===
DEBUG_RA: Restaurando RA do stack usando SP original
ADD_INSTRUCTION[174]: LW (op=25) rs=R29 rt=R31 rd=R0 imm=7
  MEM PREVIEW: Will output 'LW R31, 7(R29)'
DEBUG_RA: Restaurando FP do stack usando SP original
ADD_INSTRUCTION[175]: LW (op=25) rs=R29 rt=R30 rd=R0 imm=6
  MEM PREVIEW: Will output 'LW R30, 6(R29)'
DEBUG_RA: Restaurando SP para posição anterior (SP+8)
ADD_INSTRUCTION[176]: ADDI (op=15) rs=R29 rt=R29 rd=R0 imm=8
  ADDI PREVIEW: Will output 'ADDI R29, R29, 8'
DEBUG_RA: Gerando JR RA para retorno
ADD_INSTRUCTION[177]: JR (op=12) rs=R31 rt=R0 rd=R0 imm=0
DEBUG_RA: === FIM EPILOGO FUNCAO ===
DEBUG: Função 'main' detectada com 1 parâmetros totais
ADD_INSTRUCTION[179]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[180]: SW (op=26) rs=R2 rt=R30 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R30, 0(R2)'
ADD_INSTRUCTION[181]: SUBI (op=16) rs=R29 rt=R29 rd=R0 imm=2
ADD_INSTRUCTION[182]: MOVE (op=11) rs=R29 rt=R0 rd=R30 imm=0
DEBUG: add_instruction MOVE[182]: rs=29, rt=0, rd=30 (Armazenado: rs=29, rd=30)
...
ADD_INSTRUCTION[183]: LI (op=27) rs=R0 rt=R7 rd=R0 imm=0
...
DEBUG: add_move_if_different(R7 -> R8)
DEBUG: Gerando MOVE R8, R7
ADD_INSTRUCTION[184]: MOVE (op=11) rs=R7 rt=R0 rd=R8 imm=0
DEBUG: add_instruction MOVE[184]: rs=7, rt=0, rd=8 (Armazenado: rs=7, rd=8)
ADD_INSTRUCTION[185]: SW (op=26) rs=R30 rt=R8 rd=R0 imm=0
...
ADD_INSTRUCTION[187]: LI (op=27) rs=R0 rt=R10 rd=R0 imm=5
DEBUG: load_variable_to_register('i', 'main')
DEBUG: get_register_for_variable('i', 'main')
DEBUG: Variável 'i' já em R8 (reutilizando)
DEBUG: Variável 'i' -> R8 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[188]: LW (op=25) rs=R30 rt=R8 rd=R0 imm=0
...
ADD_INSTRUCTION[189]: SLT (op=8) rs=R8 rt=R10 rd=R11 imm=0
...
ADD_INSTRUCTION[191]: INPUT (op=34) rs=R0 rt=R0 rd=R12 imm=0
ADD_INSTRUCTION[192]: OUTPUTREG (op=32) rs=R12 rt=R0 rd=R0 imm=0
...
DEBUG: get_register_for_variable('i', 'main')
DEBUG: Variável 'i' já em R8 (reutilizando)
DEBUG: Variável 'i' -> R8 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[193]: LW (op=25) rs=R30 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R8, 0(R30)'
...
ADD_INSTRUCTION[194]: ADDI (op=15) rs=R28 rt=R13 rd=R0 imm=0
  ADDI PREVIEW: Will output 'ADDI R13, R28, 0'
Generating: ADD R13, R13, R8 (final address = base + index)
ADD_INSTRUCTION[195]: ADD (op=0) rs=R13 rt=R8 rd=R13 imm=0
  ADD PREVIEW: Will output 'ADD R13, R13, R8'
...
ADD_INSTRUCTION[196]: SW (op=26) rs=R13 rt=R12 rd=R0 imm=0
...
ADD_INSTRUCTION[197]: LI (op=27) rs=R0 rt=R14 rd=R0 imm=1
DEBUG: load_variable_to_register('i', 'main')
DEBUG: get_register_for_variable('i', 'main')
DEBUG: Variável 'i' já em R8 (reutilizando)
DEBUG: Variável 'i' -> R8 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[198]: LW (op=25) rs=R30 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R8, 0(R30)'
...
ADD_INSTRUCTION[199]: ADD (op=0) rs=R8 rt=R14 rd=R5 imm=0
...
ADD_INSTRUCTION[200]: MOVE (op=11) rs=R5 rt=R0 rd=R8 imm=0
DEBUG: add_instruction MOVE[200]: rs=5, rt=0, rd=8 (Armazenado: rs=5, rd=8)
ADD_INSTRUCTION[201]: SW (op=26) rs=R30 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R8, 0(R30)'
DEBUG: get_register_for_variable('t22', 'main')
DEBUG: Liberando R15 (era t6)
DEBUG: Alocando 't22' -> R15
ADD_INSTRUCTION[204]: LI (op=27) rs=R0 rt=R15 rd=R0 imm=0
DEBUG: get_register_for_variable('t23', 'main')
DEBUG: Liberando R16 (era t7)
DEBUG: Alocando 't23' -> R16
ADD_INSTRUCTION[205]: LI (op=27) rs=R0 rt=R16 rd=R0 imm=5
...
DEBUG: Array 'vet' -> R1 (símbolo encontrado: offset=0, global=1, is_arg=0, is_array=1)ADD_INSTRUCTION[206]: ADDI (op=15) rs=R28 rt=R1 rd=R0 imm=0
  ADDI PREVIEW: Will output 'ADDI R1, R28, 0'

DEBUG: Parâmetro 0: 'vet' de R1 para R4 (forçado)
ADD_INSTRUCTION[207]: MOVE (op=11) rs=R1 rt=R0 rd=R4 imm=0
DEBUG: add_instruction MOVE[207]: rs=1, rt=0, rd=4 (Armazenado: rs=1, rd=4)
...
ADD_INSTRUCTION[208]: MOVE (op=11) rs=R15 rt=R0 rd=R5 imm=0
DEBUG: add_instruction MOVE[208]: rs=15, rt=0, rd=5 (Armazenado: rs=15, rd=5)
...
ADD_INSTRUCTION[209]: MOVE (op=11) rs=R16 rt=R0 rd=R6 imm=0
DEBUG: add_instruction MOVE[209]: rs=16, rt=0, rd=6 (Armazenado: rs=16, rd=6)
DEBUG: Salvando R2 (contém 'k') antes da chamada
ADD_INSTRUCTION[210]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[211]: SW (op=26) rs=R2 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R2, 0(R2)'
DEBUG: Salvando R3 (contém 'addr_reg_6') antes da chamada
ADD_INSTRUCTION[212]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[213]: SW (op=26) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R3, 0(R2)'
DEBUG: Salvando R5 (contém 't21') antes da chamada
ADD_INSTRUCTION[214]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=3
ADD_INSTRUCTION[215]: SW (op=26) rs=R2 rt=R5 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R5, 0(R2)'
DEBUG: Salvando R6 (contém 't15') antes da chamada
ADD_INSTRUCTION[216]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=4
ADD_INSTRUCTION[217]: SW (op=26) rs=R2 rt=R6 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R6, 0(R2)'
DEBUG: Salvando R7 (contém 't16') antes da chamada
ADD_INSTRUCTION[218]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=5
ADD_INSTRUCTION[219]: SW (op=26) rs=R2 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R7, 0(R2)'
DEBUG: Salvando R8 (contém 'i') antes da chamada
ADD_INSTRUCTION[220]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=6
ADD_INSTRUCTION[221]: SW (op=26) rs=R2 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R8, 0(R2)'
DEBUG: Salvando R9 (contém 'high') antes da chamada
ADD_INSTRUCTION[222]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=7
ADD_INSTRUCTION[223]: SW (op=26) rs=R2 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R9, 0(R2)'
DEBUG: Salvando R10 (contém 't17') antes da chamada
ADD_INSTRUCTION[224]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=8
ADD_INSTRUCTION[225]: SW (op=26) rs=R2 rt=R10 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R10, 0(R2)'
DEBUG: Salvando R11 (contém 't18') antes da chamada
ADD_INSTRUCTION[226]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=9
ADD_INSTRUCTION[227]: SW (op=26) rs=R2 rt=R11 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R11, 0(R2)'
DEBUG: Salvando R12 (contém 't19') antes da chamada
ADD_INSTRUCTION[228]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=10
ADD_INSTRUCTION[229]: SW (op=26) rs=R2 rt=R12 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R12, 0(R2)'
DEBUG: Salvando R13 (contém 'addr_reg_7') antes da chamada
ADD_INSTRUCTION[230]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=11
ADD_INSTRUCTION[231]: SW (op=26) rs=R2 rt=R13 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R13, 0(R2)'
DEBUG: Salvando R14 (contém 't20') antes da chamada
ADD_INSTRUCTION[232]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=12
ADD_INSTRUCTION[233]: SW (op=26) rs=R2 rt=R14 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R14, 0(R2)'
DEBUG: Salvando R15 (contém 't22') antes da chamada
ADD_INSTRUCTION[234]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=13
ADD_INSTRUCTION[235]: SW (op=26) rs=R2 rt=R15 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R15, 0(R2)'
ADD_INSTRUCTION[236]: SUBI (op=16) rs=R29 rt=R29 rd=R0 imm=13
ADD_INSTRUCTION[238]: ADDI (op=15) rs=R29 rt=R29 rd=R0 imm=13
  ADDI PREVIEW: Will output 'ADDI R29, R29, 13'
DEBUG: Restaurando R15 (contém 't22') após a chamada
ADD_INSTRUCTION[239]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=13
ADD_INSTRUCTION[240]: LW (op=25) rs=R2 rt=R15 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R15, 0(R2)'
DEBUG: Restaurando R14 (contém 't20') após a chamada
ADD_INSTRUCTION[241]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=12
ADD_INSTRUCTION[242]: LW (op=25) rs=R2 rt=R14 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R14, 0(R2)'
DEBUG: Restaurando R13 (contém 'addr_reg_7') após a chamada
ADD_INSTRUCTION[243]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=11
ADD_INSTRUCTION[244]: LW (op=25) rs=R2 rt=R13 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R13, 0(R2)'
DEBUG: Restaurando R12 (contém 't19') após a chamada
ADD_INSTRUCTION[245]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=10
ADD_INSTRUCTION[246]: LW (op=25) rs=R2 rt=R12 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R12, 0(R2)'
DEBUG: Restaurando R11 (contém 't18') após a chamada
ADD_INSTRUCTION[247]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=9
ADD_INSTRUCTION[248]: LW (op=25) rs=R2 rt=R11 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R11, 0(R2)'
DEBUG: Restaurando R10 (contém 't17') após a chamada
ADD_INSTRUCTION[249]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=8
ADD_INSTRUCTION[250]: LW (op=25) rs=R2 rt=R10 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R10, 0(R2)'
DEBUG: Restaurando R9 (contém 'high') após a chamada
ADD_INSTRUCTION[251]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=7
ADD_INSTRUCTION[252]: LW (op=25) rs=R2 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R9, 0(R2)'
DEBUG: Restaurando R8 (contém 'i') após a chamada
ADD_INSTRUCTION[253]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=6
ADD_INSTRUCTION[254]: LW (op=25) rs=R2 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R8, 0(R2)'
DEBUG: Restaurando R7 (contém 't16') após a chamada
ADD_INSTRUCTION[255]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=5
ADD_INSTRUCTION[256]: LW (op=25) rs=R2 rt=R7 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R7, 0(R2)'
DEBUG: Restaurando R6 (contém 't15') após a chamada
ADD_INSTRUCTION[257]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=4
ADD_INSTRUCTION[258]: LW (op=25) rs=R2 rt=R6 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R6, 0(R2)'
DEBUG: Restaurando R5 (contém 't21') após a chamada
ADD_INSTRUCTION[259]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=3
ADD_INSTRUCTION[260]: LW (op=25) rs=R2 rt=R5 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R5, 0(R2)'
DEBUG: Restaurando R3 (contém 'addr_reg_6') após a chamada
ADD_INSTRUCTION[261]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[262]: LW (op=25) rs=R2 rt=R3 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R3, 0(R2)'
DEBUG: Restaurando R2 (contém 'k') após a chamada
ADD_INSTRUCTION[263]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=1
ADD_INSTRUCTION[264]: LW (op=25) rs=R2 rt=R2 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R2, 0(R2)'
...
ADD_INSTRUCTION[265]: MOVE (op=11) rs=R1 rt=R0 rd=R17 imm=0
DEBUG: add_instruction MOVE[265]: rs=1, rt=0, rd=17 (Armazenado: rs=1, rd=17)
ADD_INSTRUCTION[266]: MOVE (op=11) rs=R1 rt=R0 rd=R7 imm=0
DEBUG: add_instruction MOVE[266]: rs=1, rt=0, rd=7 (Armazenado: rs=1, rd=7)
DEBUG: get_register_for_variable('t25', 'main')
DEBUG: Liberando R18 (era t9)
DEBUG: Alocando 't25' -> R18
ADD_INSTRUCTION[267]: LI (op=27) rs=R0 rt=R18 rd=R0 imm=0
...
ADD_INSTRUCTION[268]: MOVE (op=11) rs=R18 rt=R0 rd=R8 imm=0
DEBUG: add_instruction MOVE[268]: rs=18, rt=0, rd=8 (Armazenado: rs=18, rd=8)
ADD_INSTRUCTION[269]: SW (op=26) rs=R30 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R8, 0(R30)'
DEBUG: get_register_for_variable('t26', 'main')
DEBUG: Liberando R19 (era t10)
DEBUG: Alocando 't26' -> R19
ADD_INSTRUCTION[271]: LI (op=27) rs=R0 rt=R19 rd=R0 imm=5
DEBUG: load_variable_to_register('i', 'main')
DEBUG: get_register_for_variable('i', 'main')
DEBUG: Variável 'i' já em R8 (reutilizando)
DEBUG: Variável 'i' -> R8 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[272]: LW (op=25) rs=R30 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R8, 0(R30)'
...
ADD_INSTRUCTION[273]: SLT (op=8) rs=R8 rt=R19 rd=R20 imm=0
...
ADD_INSTRUCTION[276]: ADDI (op=15) rs=R28 rt=R9 rd=R0 imm=0
  ADDI PREVIEW: Will output 'ADDI R9, R28, 0'
Generating: ADD R9, R9, R8 (final address = base + index)
ADD_INSTRUCTION[277]: ADD (op=0) rs=R9 rt=R8 rd=R9 imm=0
...
ADD_INSTRUCTION[278]: LW (op=25) rs=R9 rt=R21 rd=R0 imm=0
...
ADD_INSTRUCTION[279]: OUTPUTREG (op=32) rs=R21 rt=R0 rd=R0 imm=0
DEBUG: get_register_for_variable('t29', 'main')
DEBUG: Liberando R22 (era addr_reg_3)
DEBUG: Alocando 't29' -> R22
ADD_INSTRUCTION[280]: LI (op=27) rs=R0 rt=R22 rd=R0 imm=1
DEBUG: load_variable_to_register('i', 'main')
DEBUG: get_register_for_variable('i', 'main')
DEBUG: Variável 'i' já em R8 (reutilizando)
DEBUG: Variável 'i' -> R8 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[281]: LW (op=25) rs=R30 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R8, 0(R30)'
...
ADD_INSTRUCTION[282]: ADD (op=0) rs=R8 rt=R22 rd=R23 imm=0
...
ADD_INSTRUCTION[283]: MOVE (op=11) rs=R23 rt=R0 rd=R8 imm=0
DEBUG: add_instruction MOVE[283]: rs=23, rt=0, rd=8 (Armazenado: rs=23, rd=8)
ADD_INSTRUCTION[284]: SW (op=26) rs=R30 rt=R8 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R8, 0(R30)'
ADD_INSTRUCTION[287]: HALT (op=30) rs=R0 rt=R0 rd=R0 imm=0

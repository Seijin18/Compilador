...
ADD_INSTRUCTION[78]: SW (op=26) rs=R30 rt=R9 rd=R0 imm=3
  MEM PREVIEW: Will output 'SW R9, 3(R30)'
DEBUG: get_register_for_variable('t8', 'sort')
DEBUG: Registrador livre encontrado: R20
DEBUG: Alocando 't8' -> R20
ADD_INSTRUCTION[80]: LI (op=27) rs=R0 rt=R20 rd=R0 imm=1
...
DEBUG: Variável 'high' -> R10 (símbolo encontrado: offset=2, global=0)ADD_INSTRUCTION[81]: LW (op=25) rs=R30 rt=R10 rd=R0 imm=2
  MEM PREVIEW: Will output 'LW R10, 2(R30)'
...
ADD_INSTRUCTION[82]: SUB (op=1) rs=R10 rt=R20 rd=R21 imm=0
DEBUG: load_variable_to_register('i', 'sort')
DEBUG: get_register_for_variable('i', 'sort')
DEBUG: Variável 'i' já em R9 (reutilizando)
DEBUG: Variável 'i' -> R9 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[83]: LW (op=25) rs=R30 rt=R9 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R9, 3(R30)'
...
ADD_INSTRUCTION[84]: SLT (op=8) rs=R9 rt=R21 rd=R22 imm=0
...
DEBUG: Array 'a' -> R23 (símbolo encontrado: offset=0, global=0, is_arg=1, is_array=1)DEBUG: Array parameter - using LW to load address from parameter
ADD_INSTRUCTION[86]: LW (op=25) rs=R30 rt=R23 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R23, 0(R30)'

DEBUG: Parâmetro 0: 'a' de R23 para R4 (forçado)
ADD_INSTRUCTION[87]: MOVE (op=11) rs=R23 rt=R0 rd=R4 imm=0
DEBUG: add_instruction MOVE[87]: rs=23, rt=0, rd=4 (Armazenado: rs=23, rd=4)
DEBUG: Passando parâmetro 1: 'i'
DEBUG: load_variable_to_register('i', 'sort')
DEBUG: get_register_for_variable('i', 'sort')
DEBUG: Variável 'i' já em R9 (reutilizando)
DEBUG: Variável 'i' -> R9 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[88]: LW (op=25) rs=R30 rt=R9 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R9, 3(R30)'

DEBUG: Parâmetro 1: 'i' de R9 para R5 (forçado)
ADD_INSTRUCTION[89]: MOVE (op=11) rs=R9 rt=R0 rd=R5 imm=0
DEBUG: add_instruction MOVE[89]: rs=9, rt=0, rd=5 (Armazenado: rs=9, rd=5)
DEBUG: Passando parâmetro 2: 'high'
DEBUG: load_variable_to_register('high', 'sort')
DEBUG: get_register_for_variable('high', 'sort')
DEBUG: Variável 'high' já em R10 (reutilizando)
DEBUG: Variável 'high' -> R10 (símbolo encontrado: offset=2, global=0)ADD_INSTRUCTION[90]: LW (op=25) rs=R30 rt=R10 rd=R0 imm=2
  MEM PREVIEW: Will output 'LW R10, 2(R30)'

DEBUG: Parâmetro 2: 'high' de R10 para R6 (forçado)
ADD_INSTRUCTION[91]: MOVE (op=11) rs=R10 rt=R0 rd=R6 imm=0
DEBUG: add_instruction MOVE[91]: rs=10, rt=0, rd=6 (Armazenado: rs=10, rd=6)
...
ADD_INSTRUCTION[93]: MOVE (op=11) rs=R1 rt=R0 rd=R24 imm=0
DEBUG: add_instruction MOVE[93]: rs=1, rt=0, rd=24 (Armazenado: rs=1, rd=24)
...
ADD_INSTRUCTION[94]: MOVE (op=11) rs=R24 rt=R0 rd=R2 imm=0
DEBUG: add_instruction MOVE[94]: rs=24, rt=0, rd=2 (Armazenado: rs=24, rd=2)
ADD_INSTRUCTION[95]: SW (op=26) rs=R30 rt=R2 rd=R0 imm=4
...
DEBUG: get_register_for_variable('k', 'sort')
DEBUG: Variável 'k' já em R2 (reutilizando)
DEBUG: Variável 'k' -> R2 (símbolo encontrado: offset=4, global=0)ADD_INSTRUCTION[96]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=4
...
ADD_INSTRUCTION[97]: SLL (op=6) rs=R2 rt=R0 rd=R25 imm=2
Array parameter: FP=30, offset=0 (contains base address)
Generating: LW R26, 0(FP) (load base address from parameter)
ADD_INSTRUCTION[98]: LW (op=25) rs=R30 rt=R26 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R26, 0(R30)'
Generating: ADD R26, R26, R25 (final address = base + index*4)
ADD_INSTRUCTION[99]: ADD (op=0) rs=R26 rt=R25 rd=R26 imm=0
...
ADD_INSTRUCTION[100]: LW (op=25) rs=R26 rt=R27 rd=R0 imm=0
...
ADD_INSTRUCTION[101]: MOVE (op=11) rs=R27 rt=R0 rd=R3 imm=0
DEBUG: add_instruction MOVE[101]: rs=27, rt=0, rd=3 (Armazenado: rs=27, rd=3)
ADD_INSTRUCTION[102]: SW (op=26) rs=R30 rt=R3 rd=R0 imm=6
...
DEBUG: get_register_for_variable('i', 'sort')
DEBUG: Variável 'i' já em R9 (reutilizando)
DEBUG: Variável 'i' -> R9 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[103]: LW (op=25) rs=R30 rt=R9 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R9, 3(R30)'
...
ADD_INSTRUCTION[104]: SLL (op=6) rs=R9 rt=R0 rd=R4 imm=2
Array parameter: FP=30, offset=0 (contains base address)
Generating: LW R5, 0(FP) (load base address from parameter)
ADD_INSTRUCTION[105]: LW (op=25) rs=R30 rt=R5 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R5, 0(R30)'
Generating: ADD R5, R5, R4 (final address = base + index*4)
ADD_INSTRUCTION[106]: ADD (op=0) rs=R5 rt=R4 rd=R5 imm=0
...
ADD_INSTRUCTION[107]: LW (op=25) rs=R5 rt=R7 rd=R0 imm=0
...
DEBUG: get_register_for_variable('k', 'sort')
DEBUG: Variável 'k' já em R2 (reutilizando)
DEBUG: Variável 'k' -> R2 (símbolo encontrado: offset=4, global=0)ADD_INSTRUCTION[108]: LW (op=25) rs=R30 rt=R2 rd=R0 imm=4
  MEM PREVIEW: Will output 'LW R2, 4(R30)'
...
ADD_INSTRUCTION[109]: SLL (op=6) rs=R2 rt=R0 rd=R8 imm=2
Array parameter: FP=30, offset=0 (contains base address)
Generating: LW R11, 0(FP) (load base address from parameter)
ADD_INSTRUCTION[110]: LW (op=25) rs=R30 rt=R11 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R11, 0(R30)'
Generating: ADD R11, R11, R8 (final address = base + index*4)
ADD_INSTRUCTION[111]: ADD (op=0) rs=R11 rt=R8 rd=R11 imm=0
...
ADD_INSTRUCTION[112]: SW (op=26) rs=R11 rt=R7 rd=R0 imm=0
...
DEBUG: get_register_for_variable('i', 'sort')
DEBUG: Variável 'i' já em R9 (reutilizando)
DEBUG: Variável 'i' -> R9 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[113]: LW (op=25) rs=R30 rt=R9 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R9, 3(R30)'
...
Generating: SLL R12, R9, 2 (index * 4)
ADD_INSTRUCTION[114]: SLL (op=6) rs=R9 rt=R0 rd=R12 imm=2
Array parameter: FP=30, offset=0 (contains base address)
Generating: LW R13, 0(FP) (load base address from parameter)
ADD_INSTRUCTION[115]: LW (op=25) rs=R30 rt=R13 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R13, 0(R30)'
Generating: ADD R13, R13, R12 (final address = base + index*4)
ADD_INSTRUCTION[116]: ADD (op=0) rs=R13 rt=R12 rd=R13 imm=0
  ADD PREVIEW: Will output 'ADD R13, R13, R12'
DEBUG: load_variable_to_register('t', 'sort')
DEBUG: get_register_for_variable('t', 'sort')
DEBUG: Variável 't' já em R3 (reutilizando)
DEBUG: Variável 't' -> R3 (símbolo encontrado: offset=6, global=0)ADD_INSTRUCTION[117]: LW (op=25) rs=R30 rt=R3 rd=R0 imm=6
  MEM PREVIEW: Will output 'LW R3, 6(R30)'

STORE: Value register R3 (from 't')
Generating: SW R3, 0(R13) (store value at address)
ADD_INSTRUCTION[118]: SW (op=26) rs=R13 rt=R3 rd=R0 imm=0
...
ADD_INSTRUCTION[119]: LI (op=27) rs=R0 rt=R14 rd=R0 imm=1
DEBUG: load_variable_to_register('i', 'sort')
DEBUG: get_register_for_variable('i', 'sort')
DEBUG: Variável 'i' já em R9 (reutilizando)
DEBUG: Variável 'i' -> R9 (símbolo encontrado: offset=3, global=0)ADD_INSTRUCTION[120]: LW (op=25) rs=R30 rt=R9 rd=R0 imm=3
  MEM PREVIEW: Will output 'LW R9, 3(R30)'
...
ADD_INSTRUCTION[121]: ADD (op=0) rs=R9 rt=R14 rd=R15 imm=0
...
ADD_INSTRUCTION[122]: MOVE (op=11) rs=R15 rt=R0 rd=R9 imm=0
DEBUG: add_instruction MOVE[122]: rs=15, rt=0, rd=9 (Armazenado: rs=15, rd=9)
ADD_INSTRUCTION[123]: SW (op=26) rs=R30 rt=R9 rd=R0 imm=3
  MEM PREVIEW: Will output 'SW R9, 3(R30)'
DEBUG_RA: === INICIO EPILOGO FUNCAO ===
DEBUG_RA: Restaurando RA do stack usando SP original
ADD_INSTRUCTION[127]: LW (op=25) rs=R29 rt=R31 rd=R0 imm=7
  MEM PREVIEW: Will output 'LW R31, 7(R29)'
DEBUG_RA: Restaurando FP do stack usando SP original
ADD_INSTRUCTION[128]: LW (op=25) rs=R29 rt=R30 rd=R0 imm=6
  MEM PREVIEW: Will output 'LW R30, 6(R29)'
DEBUG_RA: Restaurando SP para posição anterior (SP+8)
ADD_INSTRUCTION[129]: ADDI (op=15) rs=R29 rt=R29 rd=R0 imm=8
  ADDI PREVIEW: Will output 'ADDI R29, R29, 8'
DEBUG_RA: Gerando JR RA para retorno
ADD_INSTRUCTION[130]: JR (op=12) rs=R31 rt=R0 rd=R0 imm=0
DEBUG_RA: === FIM EPILOGO FUNCAO ===
DEBUG: Função 'main' detectada com 1 parâmetros totais
ADD_INSTRUCTION[132]: SUBI (op=16) rs=R29 rt=R2 rd=R0 imm=2
ADD_INSTRUCTION[133]: SW (op=26) rs=R2 rt=R30 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R30, 0(R2)'
ADD_INSTRUCTION[134]: SUBI (op=16) rs=R29 rt=R29 rd=R0 imm=2
ADD_INSTRUCTION[135]: MOVE (op=11) rs=R29 rt=R0 rd=R30 imm=0
DEBUG: add_instruction MOVE[135]: rs=29, rt=0, rd=30 (Armazenado: rs=29, rd=30)
...
ADD_INSTRUCTION[136]: LI (op=27) rs=R0 rt=R16 rd=R0 imm=0
...
ADD_INSTRUCTION[137]: MOVE (op=11) rs=R16 rt=R0 rd=R9 imm=0
DEBUG: add_instruction MOVE[137]: rs=16, rt=0, rd=9 (Armazenado: rs=16, rd=9)
ADD_INSTRUCTION[138]: SW (op=26) rs=R30 rt=R9 rd=R0 imm=0
...
DEBUG: get_register_for_variable('i', 'main')
DEBUG: Variável 'i' já em R9 (reutilizando)
DEBUG: Variável 'i' -> R9 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[141]: LW (op=25) rs=R30 rt=R9 rd=R0 imm=0
...
ADD_INSTRUCTION[142]: SLT (op=8) rs=R9 rt=R17 rd=R6 imm=0
...
ADD_INSTRUCTION[144]: INPUT (op=34) rs=R0 rt=R0 rd=R18 imm=0
ADD_INSTRUCTION[145]: OUTPUTREG (op=32) rs=R18 rt=R0 rd=R0 imm=0
...
DEBUG: get_register_for_variable('i', 'main')
DEBUG: Variável 'i' já em R9 (reutilizando)
DEBUG: Variável 'i' -> R9 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[146]: LW (op=25) rs=R30 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R9, 0(R30)'
...
ADD_INSTRUCTION[147]: SLL (op=6) rs=R9 rt=R0 rd=R19 imm=2
Global array: GP=28, offset=0
Generating: ADDI R1, GP, 0 (base address)
ADD_INSTRUCTION[148]: ADDI (op=15) rs=R28 rt=R1 rd=R0 imm=0
  ADDI PREVIEW: Will output 'ADDI R1, R28, 0'
Generating: ADD R1, R1, R19 (final address)
ADD_INSTRUCTION[149]: ADD (op=0) rs=R1 rt=R19 rd=R1 imm=0
...
ADD_INSTRUCTION[150]: SW (op=26) rs=R1 rt=R18 rd=R0 imm=0
...
ADD_INSTRUCTION[151]: LI (op=27) rs=R0 rt=R20 rd=R0 imm=1
DEBUG: load_variable_to_register('i', 'main')
DEBUG: get_register_for_variable('i', 'main')
DEBUG: Variável 'i' já em R9 (reutilizando)
DEBUG: Variável 'i' -> R9 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[152]: LW (op=25) rs=R30 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R9, 0(R30)'
...
ADD_INSTRUCTION[153]: ADD (op=0) rs=R9 rt=R20 rd=R21 imm=0
...
ADD_INSTRUCTION[154]: MOVE (op=11) rs=R21 rt=R0 rd=R9 imm=0
DEBUG: add_instruction MOVE[154]: rs=21, rt=0, rd=9 (Armazenado: rs=21, rd=9)
ADD_INSTRUCTION[155]: SW (op=26) rs=R30 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R9, 0(R30)'
DEBUG: get_register_for_variable('t22', 'main')
DEBUG: Liberando R22 (era t10)
DEBUG: Alocando 't22' -> R22
ADD_INSTRUCTION[158]: LI (op=27) rs=R0 rt=R22 rd=R0 imm=0
...
DEBUG: Array 'vet' -> R10 (símbolo encontrado: offset=0, global=1, is_arg=0, is_array=1)ADD_INSTRUCTION[160]: ADDI (op=15) rs=R28 rt=R10 rd=R0 imm=0
  ADDI PREVIEW: Will output 'ADDI R10, R28, 0'

DEBUG: Parâmetro 0: 'vet' de R10 para R4 (forçado)
ADD_INSTRUCTION[161]: MOVE (op=11) rs=R10 rt=R0 rd=R4 imm=0
DEBUG: add_instruction MOVE[161]: rs=10, rt=0, rd=4 (Armazenado: rs=10, rd=4)
...
ADD_INSTRUCTION[162]: MOVE (op=11) rs=R22 rt=R0 rd=R5 imm=0
DEBUG: add_instruction MOVE[162]: rs=22, rt=0, rd=5 (Armazenado: rs=22, rd=5)
...
ADD_INSTRUCTION[163]: MOVE (op=11) rs=R23 rt=R0 rd=R6 imm=0
DEBUG: add_instruction MOVE[163]: rs=23, rt=0, rd=6 (Armazenado: rs=23, rd=6)
DEBUG: get_register_for_variable('t24', 'main')
DEBUG: Liberando R24 (era t11)
DEBUG: Alocando 't24' -> R24
DEBUG: add_move_if_different(R1 -> R24)
DEBUG: Gerando MOVE R24, R1
ADD_INSTRUCTION[165]: MOVE (op=11) rs=R1 rt=R0 rd=R24 imm=0
DEBUG: add_instruction MOVE[165]: rs=1, rt=0, rd=24 (Armazenado: rs=1, rd=24)
ADD_INSTRUCTION[166]: MOVE (op=11) rs=R1 rt=R0 rd=R7 imm=0
DEBUG: add_instruction MOVE[166]: rs=1, rt=0, rd=7 (Armazenado: rs=1, rd=7)
DEBUG: get_register_for_variable('t25', 'main')
DEBUG: Liberando R25 (era temp_reg_3)
DEBUG: Alocando 't25' -> R25
ADD_INSTRUCTION[167]: LI (op=27) rs=R0 rt=R25 rd=R0 imm=0
...
ADD_INSTRUCTION[168]: MOVE (op=11) rs=R25 rt=R0 rd=R9 imm=0
DEBUG: add_instruction MOVE[168]: rs=25, rt=0, rd=9 (Armazenado: rs=25, rd=9)
ADD_INSTRUCTION[169]: SW (op=26) rs=R30 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R9, 0(R30)'
...
ADD_INSTRUCTION[173]: SLT (op=8) rs=R9 rt=R26 rd=R27 imm=0
...
DEBUG: get_register_for_variable('i', 'main')
DEBUG: Variável 'i' já em R9 (reutilizando)
DEBUG: Variável 'i' -> R9 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[175]: LW (op=25) rs=R30 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R9, 0(R30)'
...
Generating: SLL R4, R9, 2 (index * 4)
ADD_INSTRUCTION[176]: SLL (op=6) rs=R9 rt=R0 rd=R4 imm=2
Global array: GP=28, offset=0
Generating: ADDI R5, GP, 0 (base address)
ADD_INSTRUCTION[177]: ADDI (op=15) rs=R28 rt=R5 rd=R0 imm=0
  ADDI PREVIEW: Will output 'ADDI R5, R28, 0'
Generating: ADD R5, R5, R4 (final address)
ADD_INSTRUCTION[178]: ADD (op=0) rs=R5 rt=R4 rd=R5 imm=0
  ADD PREVIEW: Will output 'ADD R5, R5, R4'
...
ADD_INSTRUCTION[179]: LW (op=25) rs=R5 rt=R2 rd=R0 imm=0
...
ADD_INSTRUCTION[180]: OUTPUTREG (op=32) rs=R2 rt=R0 rd=R0 imm=0
DEBUG: get_register_for_variable('t29', 'main')
DEBUG: Liberando R8 (era temp_reg_5)
DEBUG: Alocando 't29' -> R8
ADD_INSTRUCTION[181]: LI (op=27) rs=R0 rt=R8 rd=R0 imm=1
DEBUG: load_variable_to_register('i', 'main')
DEBUG: get_register_for_variable('i', 'main')
DEBUG: Variável 'i' já em R9 (reutilizando)
DEBUG: Variável 'i' -> R9 (símbolo encontrado: offset=0, global=0)ADD_INSTRUCTION[182]: LW (op=25) rs=R30 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'LW R9, 0(R30)'
...
ADD_INSTRUCTION[183]: ADD (op=0) rs=R9 rt=R8 rd=R11 imm=0
...
ADD_INSTRUCTION[184]: MOVE (op=11) rs=R11 rt=R0 rd=R9 imm=0
DEBUG: add_instruction MOVE[184]: rs=11, rt=0, rd=9 (Armazenado: rs=11, rd=9)
ADD_INSTRUCTION[185]: SW (op=26) rs=R30 rt=R9 rd=R0 imm=0
  MEM PREVIEW: Will output 'SW R9, 0(R30)'
ADD_INSTRUCTION[188]: HALT (op=30) rs=R0 rt=R0 rd=R0 imm=0
